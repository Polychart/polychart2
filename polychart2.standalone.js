...
l=this.spec.values.length;if(!$)throw d.error.depn("Pivot Tables require jQuery!");z=$("<table></table>").attr("border","1px solid black");z.attr("cellspacing",0);z.attr("cellpadding",0);for(t=0;t<f;){v=$("<tr></tr>");n=this.spec.columns[t]["var"];0===t&&1<m&&(s=$("<td></td>"),s.attr("rowspan",f),s.attr("colspan",m-1),v.append(s));v.append($("<th>"+n+":</th>").attr("align","right"));for(s=0;s<c.length;){p=c[s][n];for(u=1;s+u<c.length&&p===c[s+u][n];)u++;p=$("<td>"+p+"</td>").attr("colspan",u*l);p.attr("align",
"center");v.append(p);s+=u}z.append(v);t++}v=$("<tr></tr>");0===m&&(s=$("<td></td>"),s.attr("rowspan",a.length+1),v.append(s));for(t=0;t<m;)n=this.spec.rows[t]["var"],v.append($("<th>"+n+"</th>").attr("align","center")),t++;for(t=0;t<c.length;){f=this.spec.values;s=0;for(n=f.length;s<n;s++)p=f[s],p=$("<td>"+p["var"]+"</td>"),p.attr("align","center"),v.append(p);t++}z.append(v);for(t=0;t<a.length;){v=$("<tr></tr>");m=this.spec.rows;s=0;for(f=m.length;s<f;s++)if(n=m[s],n=n["var"],p=a[t][n],0===t||p!==
a[t-1][n]){for(l=1;t+l<a.length&&p===a[t+l][n];)l++;p=$("<td>"+p+"</td>").attr("rowspan",l);p.attr("align","center");p.attr("valign","middle");v.append(p)}for(s=0;s<c.length;){n=c[s];f=a[t];x=this.spec.values;l=0;for(u=x.length;l<u;l++)m=x[l],p=(p=b.get(f,n,m["var"]))?k[m["var"]](p):"-",v.append($("<td>"+p+"</td>").attr("align","right"));s++}z.append(v);t++}this.prepare&&this.prepare(this);this.spec.width&&z.attr("width",this.spec.width);this.spec.height&&z.attr("height",this.spec.height);this.dom=
_.isString(this.spec.dom)?$("#"+this.spec.dom):$(this.spec.dom);this.dom.empty();this.dom.append(z);if(this.callback)return this.callback(null,this)};return b}();d.pivot=function(b,a,c){return new f(b,a,c)}}).call(this);(function(){var f,r,l=function(b,a){return function(){return b.apply(a,arguments)}},c=[].indexOf||function(b){for(var a=0,c=this.length;a<c;a++)if(a in this&&this[a]===b)return a;return-1};r=function(b){_.isString(b.value)&&(b.value={"var":b.value});return b};f=function(){function b(a,
b,c){this.render=l(this.render,this);this.handleEvent=l(this.handleEvent,this);if(null==a)throw d.error.defn("No numeral specification is passed in!");this.handlers=[];this.callback=b;this.prepare=c;this.make(a)}b.prototype.make=function(a){if(!a.value)throw d.error.defn("No value defined in numeral.");this.spec=r(a);return(new d.DataProcess(this.spec,[],this.spec.strict,d.parser.numeralToData)).make(this.spec,[],this.render)};b.prototype.handleEvent=function(a){var b;b=this;return _.throttle(function(c){var f,
m,l,p,n;"guide-title"===a&&(c=d.event.make(a,this),c.dispatch(b.dom));p=b.handlers;n=[];m=0;for(l=p.length;m<l;m++)f=p[m],_.isFunction(f)?n.push(f(a,this,c,b)):n.push(f.handle(a,this,c,b));return n},300)};b.prototype.addHandler=function(a){if(0>c.call(this.handlers,a))return this.handlers.push(a)};b.prototype.render=function(a,b,c){var f,m,l,p;if(null!=a)console.error(a);else{this.value=b[0][this.spec.value["var"]];this.title=null!=(l=this.spec.title)?l:this.spec.value["var"];a=0<(m=this.value)&&
1>m?void 0:0===this.value%1?0:-1;this.value=d.format.number(a)(this.value);if(_.isNaN(this.value)||"NaN"===this.value)this.value="Not a Number";null!=this.prepare&&this.prepare(this);this.dom=this.spec.dom;this.width=null!=(f=this.spec.width)?f:200;this.height=null!=(p=this.spec.height)?p:100;null==this.paper&&(this.paper=this._makePaper(this.dom,this.width,this.height,this));null==this.titleObj&&(this.titleObj=this.paper.text(this.width/2,10,""));this.titleObj.attr({text:this.title,"font-size":"12px"});
this.titleObj.click(this.handleEvent("guide-title"));this.titleObj.hover(this.handleEvent("tover"),this.handleEvent("tout"));null==this.textObj&&(this.textObj=this.paper.text(this.width/2,this.height/2,""));this.textObj.attr({x:this.width/2,y:7+this.height/2,text:this.value});f=this.textObj.getBBox();m=f.width;f=f.height;m=Math.min(0.9*this.width/m,0.9*(this.height-14)/f);this.textObj.transform("s"+m);this.callback&&this.callback(null,this)}};b.prototype._makePaper=function(a,b,c,f){return d.paper(a,
b,c,{numeral:f})};return b}();d.numeral=function(b,a,c){try{return new f(b,a,c)}catch(g){console.log(g);if(null!=a)return a(g,null);throw d.error.defn("Bad specification.");}}}).call(this);(function(){var f,r,l,c={}.hasOwnProperty,b=function(a,b){function d(){this.constructor=a}for(var f in b)c.call(b,f)&&(a[f]=b[f]);d.prototype=b.prototype;a.prototype=new d;a.__super__=b.prototype;return a};r=function(){function a(a,b,c){null==a&&(a="polyjsEvent");this.eventName=a;this.cancelable=this.bubbles=!0;
this.detail={type:c,data:b}}a.prototype.dispatch=function(a){var b;b=new CustomEvent(this.eventName,{detail:this.detail});if(null!=a)return a.dispatchEvent(b)};return a}();l=function(a){function c(a,b){c.__super__.constructor.call(this,"title-click",a,b)}b(c,a);return c}(r);f=function(a){function c(a,b){c.__super__.constructor.call(this,"legend-click",a,b)}b(c,a);return c}(r);d.event={};d.event.make=function(a,b){if("guide-title"===a||"guide-titleH"===a||"guide-titleV"===a)return new l(b,a);if("legend-label"===
a||"legend-title"===a)return new f(b,a);throw d.error.defn("No such event "+a+".");}}).call(this);(function(){var f,r=function(c,b){return function(){return c.apply(b,arguments)}},l=[].indexOf||function(c){for(var b=0,a=this.length;b<a;b++)if(b in this&&this[b]===c)return b;return-1};f=function(){function c(b,a,c){null==a&&(a=null);null==c&&(c=null);this.handleEvent=r(this.handleEvent,this);this.render=r(this.render,this);this.mergeDomains=r(this.mergeDomains,this);this.merge=r(this.merge,this);this.maybeDispose=
r(this.maybeDispose,this);if(null==b)throw d.error.defn("No graph specification is passed in!");this.handlers=[];this.coord=this.paper=this.dims=this.legends=this.axes=this.scaleSet=null;this.facet=d.facet.make();this.dataSubscribed=[];this.callback=a;this.prepare=c;this.make(b);this.addHandler(d.handler.tooltip())}c.prototype.maybeDispose=function(b){var a;a=d.render(this.handleEvent,this.paper,this.scaleSet.scales,this.coord);a=a();if(this.coord&&!_.isEqual(this.coord.spec,b.coord))return this.scaleSet&&
(this.scaleSet.disposeGuides(a),this.scaleSet=null),this.coord=null};c.prototype.make=function(b){var a,c,f,h,m,l,p,n,r,k=this;null!=b?(b=d.spec.toStrictMode(b),d.spec.check(b),this.spec=b):b=this.spec;this.scaleSet&&this.maybeDispose(b);null==this.coord&&(this.coord=d.coord.make(this.spec.coord));this.facet.make(b);c=this.handleEvent("data");f=function(){var a,c,d,e;d=b.layers;e=[];h=a=0;for(c=d.length;a<c;h=++a)m=d[h],e.push(m.data);return e}();r=_.difference(f,this.dataSubscribed);p=0;for(n=r.length;p<
n;p++)a=r[p],a.subscribe(c);this.dataSubscribed=f;l=_.after(b.layers.length,this.merge);this.dataprocess={};this.processedData={};return _.each(b.layers,function(a,c){var e;b=k.spec.layers[c];e=_.values(k.facet.specgroups);k.dataprocess[c]=new d.DataProcess(b,e,b.strict);return k.dataprocess[c].make(b,e,function(a,b,e){if(null!=a)if(console.error(a),null!=k.callback)k.callback(a,null);else throw d.error.defn("Error processing data!");k.processedData[c]={statData:b,metaData:e};return l()})})};c.prototype.merge=
function(){var b=this;this.layers=_.map(this.spec.layers,function(a){return d.layer.make(a,b.spec.strict,b.spec.guides)});this.facet.calculate(this.processedData,this.layers);this.mergeDomains();return this.render()};c.prototype.mergeDomains=function(){var b,a,c;b=_.map(this.facet.panes,function(a){return a.domains});b=d.domain.merge(b);this.scaleSet||(a=d.dim.guess(this.spec,this.facet.getGrid()),this.coord.make(a),c=this.coord.ranges(),this.scaleSet=d.scaleset(c,this.coord));this.scaleSet.make(this.spec.guides,
