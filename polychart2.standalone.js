...
;
window.polyjs=function(X){if(!X){var c={};(function(){var n=[].indexOf||function(c){for(var l=0,d=this.length;l<d;l++)if(l in this&&this[l]===c)return l;return-1};c.groupBy=function(n,l){return _.groupBy(n,c.stringify(l))};c.stringify=function(c){return function(l){return _.reduce(c,function(d,b){return""+d+b+":"+l[b]+";"},"")}};c.cross=function(n,l){var d,b,a,e,h,k,m,t,p,q;null==l&&(l=[]);a=_.difference(_.keys(n),l);if(0===a.length)return[{}];d=[];e=a[0];a=c.cross(n,l.concat(e));q=n[e];k=0;for(t=
...
l,d,b,a,e,h,k,m,t,p,q,f,g,r,u,v,C,A,y,J,E,z,D,x,F,I,H,R,ca,S,B,da,ea,Q,L,P,fa,ga,U,Y,ha,V,G,K,ia,T,Z,aa,ja,W,ka,M,N,X,ba,w=function(a,b){return function(){return a.apply(b,arguments)}},ma={}.hasOwnProperty,O=function(a,b){function f(){this.constructor=a}for(var g in b)ma.call(b,g)&&(a[g]=b[g]);f.prototype=b.prototype;a.prototype=new f;a.__super__=b.prototype;return a},na=[].slice,la=[].indexOf||function(a){for(var b=0,f=this.length;b<f;b++)if(b in this&&this[b]===a)return b;return-1};x=function(a){return a.replace(/[\[\]\\]/g,
function(a){return"\\"+a})};W=function(a){return a.replace(/\\./g,function(a){return a.slice(1)})};D=function(a){return"["+x(a)+"]"};ja=function(a){var b;b=a.length;"["===a[0]&&"]"===a[b-1]&&(a=a.slice(1,+(b-2)+1||9E9),a=W(a));return a};fa=function(a){return'"'+a.replace(/["\\]/g,function(a){return"\\"+a})+'"'};ka=function(a){var b,f,g,c,r;b=a.length;r=['"',"'"];g=0;for(c=r.length;g<c;g++)if(f=r[g],a[0]===f&&a[b-1]===f){a=a.slice(1,+(b-2)+1||9E9);a=W(a);break}return a};U=function(a,b){return""+a+
...
d=_.zip(this.domains,f.domains);r=0;for(e=d.length;r<e;r++)c=d[r],g=c[0],c=c[1],g._runify(a,c);return this.range._runify(a,f.range)};return b}(a);a.Base=_.object(function(){var a,b;a={cat:"cat",num:"num",date:"date",stat:"stat"};b=[];for(Q in a)ga=a[Q],b.push([Q,new n(ga)]);return b}());C=function(){function a(b){this.toString=w(this.toString,this);this.get=w(this.get,this);this.peek=w(this.peek,this);this.empty=w(this.empty,this);var f,g,c,r;r=[];g=0;for(c=b.length;g<c;g++)f=b[g],r.push(f);this.buffer=
r.reverse()}a.prototype.empty=function(){return 0===this.buffer.length};a.prototype.peek=function(){return this.empty()?null:this.buffer[this.buffer.length-1]};a.prototype.get=function(){return this.empty()?null:this.buffer.pop()};a.prototype.toString=function(){return U("Stream",Y(na.call(this.buffer).reverse()))};return a}();y=function(){function a(b){this.tag=b;this.contents=w(this.contents,this);this.toString=w(this.toString,this)}a.Tag={symbol:"symbol",literal:"literal",infixsymbol:"infixsymbol",
keyword:"keyword",lparen:"(",rparen:")",comma:","};a.prototype.toString=function(){return"<"+this.contents().toString()+">"};a.prototype.contents=function(){return[this.tag]};return a}();A=function(a){function b(a){this.name=a;this.contents=w(this.contents,this);this.name=ja(this.name);b.__super__.constructor.call(this,y.Tag.symbol)}O(b,a);b.prototype.contents=function(){return b.__super__.contents.call(this).concat([this.name])};return b}(y);g=function(b){function f(b,g){this.val=b;this.type=g;this.contents=
w(this.contents,this);f.__super__.constructor.call(this,y.Tag.literal);this.type===a.Base.cat&&(this.val=ka(this.val))}O(f,b);f.prototype.contents=function(){return f.__super__.contents.call(this).concat([this.val])};return f}(y);p=function(a){function b(a){this.op=a;this.contents=w(this.contents,this);b.__super__.constructor.call(this,y.Tag.infixsymbol)}O(b,a);b.prototype.contents=function(){return b.__super__.contents.call(this).concat([this.op])};return b}(y);q=function(a){function b(a){this.name=
a;this.contents=w(this.contents,this);b.__super__.constructor.call(this,y.Tag.keyword)}O(b,a);b.prototype.contents=function(){return b.__super__.contents.call(this).concat([this.name])};return b}(y);h=function(){var a,b,f,g;f=[y.Tag.lparen,y.Tag.rparen,y.Tag.comma];g=[];a=0;for(b=f.length;a<b;a++)V=f[a],g.push(new y(V));return g}();f=h[0];v=h[1];l=h[2];S="++ * / % + - >= > <= < != ==".split(" ");ca=function(a,b){return S.indexOf(a)<=S.indexOf(b)};h=function(){var a,b,f;f=[];a=0;for(b=S.length;a<b;a++)ha=
S[a],f.push(ha.replace(/[+*]/g,function(a){return"(\\"+a+")"}));return f}();h=RegExp("^("+h.join("|")+")");da=["if","then","else"];aa=[[/^\(/,function(){return f}],[/^\)/,function(){return v}],[/^,/,function(){return l}],[/^[+-]?(0x[0-9a-fA-F]+|0?\.\d+|[1-9]\d*(\.\d+)?|0)([eE][+-]?\d+)?/,function(b){return new g(b,a.Base.num)}],[/^(([\w|\.]|[^\u0000-\u0080])+|\[((\\.)|[^\\\[\]])+\])/,function(a){return 0<=la.call(da,a)?new q(a):new A(a)}],[/^('((\\.)|[^\\'])*'|"((\\.)|[^\\"])+")/,function(b){return new g(b,
a.Base.cat)}],[h,function(a){return new p(a)}]];ea=function(a){var b,f,g,r;g=0;for(r=aa.length;g<r;g++)if(f=aa[g],b=f[0],f=f[1],b=b.exec(a))return g=b[0],[a.slice(g.length),f(g)];throw c.error.defn("There is an error in your specification at "+a);};Z=function(a){var b,f;for(f=[];;){a=a.replace(/^\s+/,"");if(!a)break;b=ea(a);a=b[0];b=b[1];f.push(b)}return f};h=function(){function a(){}a.prototype.toString=function(){return U(this.constructor.name,this.contents())};return a}();m=function(a){function b(a){this.name=
...
return U(b,r)};b.prototype.visit=function(a){var b;return a.call(this,this.fname,function(){var f,g,c,r;c=this.args;r=[];f=0;for(g=c.length;f<g;f++)b=c[f],r.push(b.visit(a));return r}.call(this))};return b}(h);t=function(a){function b(a,f,g){this.opsym=a;this.lhs=f;this.rhs=g;this.visit=w(this.visit,this);this.pretty=w(this.pretty,this);this.contents=w(this.contents,this)}O(b,a);b.prototype.contents=function(){return[this.lhs,this.opsym,this.rhs]};b.prototype.pretty=function(){return"("+[this.lhs.pretty(),
...
break}return a};a.prototype.push=function(a,b){a=this._reduce(a,function(a){return ca(a,b)});return this.ops.push([a,b])};a.prototype.finish=function(a){return this._reduce(a,function(a){return!0})};return a}();E=function(a,b){if(a!==b)throw c.error.defn("Expected "+b+" but received "+a);};z=function(a,b){return E(a.tag,b)};u=function(){function a(b){this.stream=b;this.parseFinish=w(this.parseFinish,this);this.parseInfix=w(this.parseInfix,this);this.parseCallArgs=w(this.parseCallArgs,this);this.parseCall=
...
!0);return this.expect(function(){return a},[[[y.Tag.lparen],this.parseCall(f)]])};a.prototype.parseCall=function(a){var b=this;return function(g){var c;z(a,y.Tag.symbol);E(b.stream.get(),f);c=a.name;g=b.expect(b.parseCallArgs([]),[[[y.Tag.rparen],function(){b.stream.get();return[]}]]);return new s(c,g)}};a.prototype.parseCallArgs=function(a){var b=this;return function(){var f,g;f=b.parseSubExpr();g=a.concat([f]);return b.expect(b.parseFail,[[[y.Tag.rparen],function(){b.stream.get();return g}],[[y.Tag.comma],
function(){b.stream.get();return b.parseCallArgs(g)()}]])}};a.prototype.parseInfix=function(a){var b=this;return function(){var f;f=b.stream.get();z(f,y.Tag.infixsymbol);b.ops.push(a,f.op);return b.parseExpr()}};a.prototype.parseFinish=function(a){var b=this;return function(){return b.ops.finish(a)}};return a}();P=function(a){a=new C(Z(a));return(new u(a)).parseTopExpr()};I=function(b,f,g){var r;r=function(a,f){var g,r;if(!(a in b))throw c.error.defn("Unknown function name: "+a);"bin"===a&&(2===f.length&&
f[0]===K)&&(a="bin_date");"min"!==a&&"max"!==a||(1!==f.length||f[0]!==K)||(a+="_date");"count"!==a&&"unique"!==a&&"lag"!==a||1!==f.length||(f[0]===G?a+="_cat":f[0]===K&&(a+="_date"));"parseDate"===a&&1===f.length&&(a="parseDateDefault");g=b[a];r=new J;g.unify(new k(f,r));return r.found};return g.visit({ident:function(a,b){if(b in f)return f[b];throw c.error.defn("Unknown column name: "+b);},"const":function(a,b,f){return f},call:function(a,b,f){return r(b,f)},infixop:function(a,b,f,g){return r(b,
[f,g])},conditional:function(b,f,g,c){f.unify(a.Base.num);g.unify(c);return g}})};G=a.Base.cat;h=a.Base.num;K=a.Base.date;L=new k([h,h],h);B={"++":new k([G,G],G)};ba="* / % + - >= > <= < != == =".split(" ");M=0;for(N=ba.length;M<N;M++)H=ba[M],B[H]=L;N=["sum","mean","box","median"];L=0;for(M=N.length;L<M;L++)H=N[L],B[H]=new k([h],a.Base.stat);N=["min","max"];L=0;for(M=N.length;L<M;L++)H=N[L],B[H]=new k([h],a.Base.stat),B[H+"_date"]=new k([K],a.Base.stat);N=["count","unique"];L=0;for(M=N.length;L<M;L++)H=
N[L],B[H]=new k([h],a.Base.stat),B[H+"_cat"]=new k([G],a.Base.stat),B[H+"_date"]=new k([K],a.Base.stat);N=["lag"];M=0;for(L=N.length;M<L;M++)H=N[M],B[H]=new k([h,h],h),B[H+"_cat"]=new k([G,h],G),B[H+"_date"]=new k([K,h],K);B.log=new k([h],h);B.substr=new k([G,h,h],G);B.length=new k([G],h);B.upper=new k([G],G);B.lower=new k([G],G);B.indexOf=new k([G,G],h);B.parseNum=new k([G],h);B.parseDate=new k([G,G],K);B.parseDateDefault=new k([G],K);B.year=new k([K],h);B.month=new k([K],h);B.dayOfMonth=new k([K],
h);B.dayOfYear=new k([K],h);B.dayOfWeek=new k([K],h);B.hour=new k([K],h);B.minute=new k([K],h);B.second=new k([K],h);B.bin=new k([h,h],h);B.bin_date=new k([K,G],K);F=function(a){return a.visit({ident:function(a,b){return["ident",{name:b}]},"const":function(a,b,f){return["const",{value:b,type:f.name}]},call:function(a,b,f){return["call",{fname:b,args:f}]},infixop:function(a,b,f,g){return["infixop",{opname:b,lhs:f,rhs:g}]},conditional:function(a,b,f,g){return["conditional",{cond:b,conseq:f,altern:g}]}})};
T=_.clone(B);T.sum=new k([h],a.Base.stat);T.log=new k([h],h);T.nameCollision=new k([G],h);ia={x:h,nameCollision:G};R=function(a){var b;try{if(b=P(a),"name"in b)return b.name}catch(f){}return a};c.parser={tj:function(a){a=P(a);return F(a)},tc:function(a){a=P(a);return I(T,ia,a)},ttc:function(){var b,f,g,c;f=a.Base.cat;g=a.Base.num;c=new J;b=new k([f,g,c,g],g);f=new k([f,g,f,c],g);return b.unify(f)},createColTypeEnv:function(b){var f,g,c;f={};for(g in b)c=b[g],f[g]=a.Base[c.type];return f},getExpression:function(a){var b,
f,g,c;"count(*)"===a&&(a="count(1)");b=P(a);f=function(a){return{name:a.pretty(),expr:F(a)}};g=function(){};a=f(b);return{exprType:"ident"===a.expr[0]?"ident":!_.has(b,"fname")||"sum"!==(c=b.fname)&&"count"!==c&&"unique"!==c&&"mean"!==c&&"box"!==c&&"median"!==c&&"min"!==c&&"max"!==c?"trans":(g=function(){var a,g=b.fname,c,r,e,d;e=b.args;d=[];r=0;for(c=e.length;r<c;r++)a=e[r],d.push(f(a));return{fname:g,args:d}},"stat"),expr:a,statInfo:g}},getType:function(a,b,f){null==f&&(f=!0);a=I(B,b,P(a));return f&&
"stat"===a.name?"num":a.name},tokenize:Z,parse:P,bracket:D,unbracket:R,normalize:function(a){return R(P(a).pretty())},escape:x,unescape:W}}).call(this);(function(){var n,s,l,d,b,a={}.hasOwnProperty,e=function(b,c){function e(){this.constructor=b}for(var d in c)a.call(c,d)&&(b[d]=c[d]);e.prototype=c.prototype;b.prototype=new e;b.__super__=c.prototype;return b},h=function(a,b){return function(){return a.apply(b,arguments)}};s=function(){function a(b){var c;this.spec=b;null==this.spec&&(this.spec={});
this.flip=null!=(c=this.spec.flip)?c:!1;this.scales=null;b=this.flip?["y","x"]:["x","y"];this.x=b[0];this.y=b[1]}a.prototype.make=function(a){return this.dims=a};a.prototype.setScales=function(a){return this.scales={x:a.x.f,y:a.y.f}};a.prototype.clipping=function(a){return[a.x,a.y,this.dims.eachWidth,this.dims.eachHeight]};a.prototype.getScale=function(a){};a.prototype.ranges=function(){};return a}();n=function(a){function b(){return d=b.__super__.constructor.apply(this,arguments)}e(b,a);b.prototype.type=
"cartesian";b.prototype.getScale=function(a){if("x"===a||"y"===a)return this.scales[this[a]];throw c.error.input("Coordinates only keep x & y scales");};b.prototype.ranges=function(){var a;a={};a[this.x]={min:0,max:this.dims.eachWidth};a[this.y]={min:this.dims.eachHeight,max:0};return a};b.prototype.axisType=function(a){return this[a]};b.prototype.getXY=function(a,b){var c,f;if(a)return c={x:_.isArray(b.x)?_.map(b.x,this.scales.x):this.scales.x(b.x),y:_.isArray(b.y)?_.map(b.y,this.scales.y):this.scales.y(b.y)},
{x:c[this.x],y:c[this.y]};c=this.scales[this.x];f=this.scales[this.y];return{x:_.isArray(b.x)?_.map(b.x,c):c(b.x),y:_.isArray(b.y)?_.map(b.y,f):f(b.y)}};b.prototype.getAes=function(a,b,c){return{x:c.x(a[this.x],b[this.x]),y:c.y(a[this.y],b[this.y])}};return b}(s);l=function(a){function d(){this.getXY=h(this.getXY,this);return b=d.__super__.constructor.apply(this,arguments)}e(d,a);d.prototype.type="polar";d.prototype.make=function(a){this.dims=a;this.cx=this.dims.eachWidth/2;return this.cy=this.dims.eachHeight/
2};d.prototype.getScale=function(a){if("r"===a)return this.scales[this.x];if("t"===a)return this.scales[this.y];throw c.error.input("Coordinates only keep r & t scales");};d.prototype.ranges=function(){var a,b,c;b=[this.x,this.y];a=b[0];c=b[1];b={};b[c]={min:0,max:2*Math.PI};b[a]={min:0,max:Math.min(this.dims.eachWidth,this.dims.eachHeight)/2-10};return b};d.prototype.axisType=function(a){return"x"===this[a]?"r":"t"};d.prototype.getXY=function(a,b){var c,f,g,r,e,d,h,k,m,l,E,z,D,x,F=this;l=function(a,
b){return F.cx+a*Math.cos(b-Math.PI/2)};E=function(a,b){return F.cy+a*Math.sin(b-Math.PI/2)};r=[this.x,this.y];e=r[0];h=r[1];if(a){if(_.isArray(b[e])){r={x:[],y:[],r:[],t:[]};D=b[e];f=c=0;for(z=D.length;c<z;f=++c)d=D[f],d=this.scales[e](d),k=this.scales[h](b[h][f]),r.x.push(l(d,k)),r.y.push(E(d,k)),r.r.push(d),r.t.push(k);return r}d=this.scales[e](b[e]);k=this.scales[h](b[h]);return{x:l(d,k),y:E(d,k),r:d,t:k}}g=function(a){return _.isObject(a)&&"scalefn"===a.t&&"identity"===a.f};c=function(a,b){var f,
c;f=g(a);c=g(b);if(f&&!c)return{x:a.v,y:E(F.scales[e](b),0)};if(f&&c)return{x:a.v,y:b.v};if(!f&&c)return{y:b.v,x:E(F.scales[h](a),0)};d=F.scales[e](b);k=F.scales[h](a);return{x:l(d,k),y:E(d,k)}};if(_.isArray(b.x)){r={x:[],y:[]};x=b.x;f=z=0;for(D=x.length;z<D;f=++z)m=x[f],f=b.y[f],m=c(m,f),f=m.x,m=m.y,r.x.push(f),r.y.push(m);return r}return c(b.x,b.y)};return d}(s);c.coord={cartesian:function(a){return new n(a)},polar:function(a){return new l(a)}};c.coord.make=function(a){if(null==a||null==a.type)return c.coord.cartesian();
switch(a.type){case "cartesian":return c.coord.cartesian(a);case "polar":return c.coord.polar(a);default:throw c.error.defn("No such coordinate type "+a.type+".");}}}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1};d=c["const"].aes;c.domain={};c.domain.make=function(a,b,e,f){var g,r,d;g=[];for(d in a)r=a[d],g.push(h(r.geoms,b[d],e,f));return c.domain.merge(g)};c.domain.compare=function(a){return a?
"cat"===a.type?function(b,c){b=_.indexOf(a.levels,b);c=_.indexOf(a.levels,c);return-1===b?1:-1===c?-1:b<c?-1:b>c?1:0}:c.type.compare(a.type):function(a){return a}};l=function(){return function(a){this.type=a.type;this.min=a.min;this.max=a.max;this.bw=a.bw}}();s=function(){return function(a){this.type=a.type;this.min=a.min;this.max=a.max;this.bw=a.bw}}();n=function(){return function(a){this.type=a.type;this.levels=a.levels;this.sorted=a.sorted}}();e=function(a){"cat"!==a.type&&a.max===a.min&&(a.bw?
(a.max+=a.bw,a.min-=a.bw):0===a.max?a.max+=1:(a.max*=1.1,a.min/=1.1));switch(a.type){case "num":return new l(a);case "date":return new s(a);case "cat":return new n(a)}};c.domain.single=function(a,b,d){var f,g,r,u,v,h,k,m,l,E,z,D,x,F,I,H,R,n,s;if(0===a.length)throw c.error.input("Dataset is none?");g=function(a){return null!=d?d[a]:null};switch(b.type){case "num":return f=null!=(u=g("bw"))?u:b.bw,1<a.length?(b=null!=(v=g("min"))?v:_.min(a),r=null!=(D=g("max"))?D:_.max(a)+(null!=f?f:0)):1===a.length?
f?(b=null!=(x=g("min"))?x:a[0],r=null!=(F=g("max"))?F:a[0]+f):(b=null!=(I=g("min"))?I:a[0]-1,r=null!=(H=g("max"))?H:a[0]+1):(b=null!=(R=g("min"))?R:0,r=null!=(n=null!=(s=g("max"))?s:f)?n:1),e({type:"num",min:b,max:r,bw:f});case "date":return f=null!=(h=g("bw"))?h:b.bw,b=null!=(k=g("min"))?k:_.min(a),r=g("max"),null==r&&(r=_.max(a),r=function(){switch(f){case "week":return moment.unix(r).add("days",7).unix();case "twomonth":return moment.unix(r).add("months",2).unix();case "quarter":return moment.unix(r).add("months",
4).unix();case "sixmonth":return moment.unix(r).add("months",6).unix();case "twoyear":return moment.unix(r).add("years",2).unix();case "fiveyear":return moment.unix(r).add("years",5).unix();case "decade":return moment.unix(r).add("years",10).unix();default:return moment.unix(r).add(f+"s",1).unix()}}()),e({type:"date",min:b,max:r,bw:f});case "cat":return e({type:"cat",levels:null!=(m=null!=(l=g("levels"))?l:b.levels)?m:_.uniq(a),sorted:null!=(E=null!=(z=g("levels"))?z:b.sorted)?E:!1})}};h=function(b,
d,h,f){var g,r,u,v,k;r={};for(g in d)v=d[g],u=h[g],0<=m.call(c["const"].noDomain,g)||(f?r[g]=e(h[g]):(k=a(b,g),r[g]=c.domain.single(k,v,u)));return r};a=function(a,b){var e,f,g,r,d;r=[];for(f in a)for(g in e=a[f],d=e.marks,d)e=d[g],r=r.concat(c.flatten(e[b]));d=[];g=0;for(e=r.length;g<e;g++)f=r[g],c.isDefined(f)&&d.push(f);return d};c.domain.merge=function(a){var b,c,f,g,r;f={};g=0;for(r=d.length;g<r;g++)b=d[g],c=_.without(_.pluck(a,b),void 0),0<c.length&&(f[b]=k(c));return f};b={num:function(a){var b,
d;b=_.compact(_.uniq(_.map(a,function(a){return a.bw})));if(1<b.length)throw c.error.data("Not all layers have the same binwidth.");b=null!=(d=b[0])?d:void 0;d=_.min(_.map(a,function(a){return a.min}));a=_.max(_.map(a,function(a){return a.max}));return e({type:"num",min:d,max:a,bw:b})},date:function(a){var b,d;b=_.compact(_.uniq(_.map(a,function(a){return a.bw})));if(1<b.length)throw c.error.data("Not all layers have the same binwidth.");b=null!=(d=b[0])?d:void 0;d=_.min(_.map(a,function(a){return a.min}));
a=_.max(_.map(a,function(a){return a.max}));return e({type:"date",min:d,max:a,bw:b})},cat:function(a){var b,d,f,g,r,u,v,h;g=[];r=0;for(v=a.length;r<v;r++)if(d=a[r],d.sorted){b=!0;u=0;for(h=g.length;u<h;u++)f=g[u],_.isEqual(f,d.levels)&&(b=!1);b&&g.push(d.levels)}a=_.chain(a).filter(function(a){return!a.sorted}).map(function(a){return a.levels}).value();if(1<g.length&&_.intersection.apply(this,g))throw c.error.data("You are trying to combine incompatible sorted domains in the same axis.");g=[_.flatten(g,
!0)];a=_.union.apply(this,g.concat(a));0===g[0].length&&(a=a.sort());return e({type:"cat",levels:a,sorted:0!==g[0].length})}};k=function(a){var e;e=_.uniq(_.map(a,function(a){return a.type}));if(1<e.length)throw c.error.data("You are trying to merge data of different types in the same axis or legend.");return b[e[0]](a)}}).call(this);(function(){var n,s,l,d;c.tick={};c.tick.make=function(b,a,e){var h,k,m,n,p,q,f,g;p=null;h=function(a){return a};null!=a.ticks?q="num"===e?_.filter(a.ticks,function(a){return a>=
b.min&&a<=b.max}):a.ticks:(h=null!=(q=a.numticks)?q:5,h=d[e](b,h),q=h.ticks,p=h.step);h=a.labels?function(b){var f;return null!=(f=a.labels[b])?f:b}:a.formatter?a.formatter:c.format(e.split("-")[0],p);p={};e=l(e,h);if(q)for(k=f=0,g=q.length-1;0<=g?f<=g:f>=g;k=0<=g?++f:--f)n=0===k?null:q[k-1],m=k===q.length-1?null:q[k+1],k=q[k],m=e(k,n,m),p[m.value]=m;return{ticks:p,ticksFormatter:h}};n=function(){return function(b){this.location=b.location;this.value=b.value;this.index=b.index;this.evtData=b.evtData}}();
l=function(b,a){var c;c=0;return function(d,k,m){var l;"cat"===b?l={"in":[d]}:(l={},null!=k&&(l.ge=k),null!=m&&(l.le=m));return new n({location:d,value:a(d),index:c++,evtData:l})}};s=function(b,a){var c,d;d=Math.pow(10,Math.floor(Math.log(b/a)/Math.LN10));c=a/b*d;0.15>c?d*=10:0.35>=c?d*=5:0.75>=c&&(d*=2);return d};d={none:function(){return{}},cat:function(b,a){var c,d,k,m,l,p,q;k=Math.max(1,Math.round(b.levels.length/a));m=[];q=b.levels;c=l=0;for(p=q.length;l<p;c=++l)d=q[c],0===c%k&&m.push(d);return{ticks:m}},
num:function(b,a){var c,d,k,m;k=b.min;d=b.max;if(c=b.bw){for(;(d-k)/c>1.4*a;)c*=2;m=k}else c=s(d-k,a),m=Math.ceil(k/c)*c;for(k=[];m<=d;)k.push(m),m+=c;return{ticks:k,step:Math.floor(Math.log(c)/Math.LN10)}},"num-log":function(b,a){var d,h,k,m,l,p,q,f,g;f=[];p=b.min;l=b.max;h=function(a){return Math.log(a)/Math.LN10};d=function(a){return Math.exp(a*Math.LN10)};m=Math.max(h(p),0);k=h(l);q=s(k-m,a);for(g=Math.ceil(m/q)*q;g<k+c["const"].epsilon;){if(!(0!==g%1&&0.1>=g%1)){if(g%1>c["const"].epsilon){if(m=
Math.floor(g)+h(10*(g%1)),0===m%1){g+=q;continue}}else m=g;m=d(m);m<p||m>l||f.push(m)}g+=q}return{ticks:f}},date:function(b,a){var d,h,k,m,l,p,q;m=b.min;k=b.max;if(d=b.bw)for(l=d;"decade"!==l&&(k-m)/c["const"].approxTimeInSeconds[l]>1.4*a;)l=c["const"].timerange[_.indexOf(c["const"].timerange,l)+1];else for(h in d=(k-m)/a,l="decade",q=c["const"].approxTimeInSeconds,q)if(p=q[h],d<1.4*p){l=h;break}p=[];h=moment.unix(m).startOf(l);d=function(){switch(l){case "twomonth":return["months",2];case "quarter":return["months",
4];case "sixmonth":return["months",6];case "twoyear":return["years",2];case "fiveyear":return["years",5];case "decade":return["years",10];default:return[l+"s",1]}}();for(h.unix()<m&&h.add(d[0],d[1]);h.unix()<=k;)p.push(h.unix()),h.add(d[0],d[1]);return{ticks:p,step:l}}}}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m,t=function(a,b){return function(){return a.apply(b,arguments)}},p={}.hasOwnProperty,q=function(a,b){function c(){this.constructor=a}for(var d in b)p.call(b,d)&&(a[d]=b[d]);c.prototype=
b.prototype;a.prototype=new c;a.__super__=b.prototype;return a};a=c["const"].scaleFns;n=function(a){function b(){this.render=t(this.render,this);this.make=t(this.make,this);this.position="none";this.title=this.titletext=null}q(b,a);b.prototype.make=function(a){var b,f,g,c;b=a.guideSpec;g=a.title;f=a.position;this.size=a.size;this.color=a.color;a=function(a,f){var g;return null!=(g=b[a])?g:f};this.titletext=a("title",g);this.position=null!=(c=a("position",f))?c:this.defaultPosition;if("out"===this.position)return this.position=
"bottom"};b.prototype.render=function(a,b,f){if("none"!==this.position)return null!=this.title&&a.remove(this.title),this.title=a.add(this._makeTitle(b,f),null,null,"guide-"+this.titleType);if(null!=this.title)return a.remove(this.title)};b.prototype.dispose=function(a){a.remove(this.title);return this.title=null};b.prototype._makeTitle=function(){throw c.error.impl();};b.prototype.getDimension=function(){var a;a={};"none"!==this.position&&(a[this.position]=10);return a};return b}(c.Guide);l=function(b){function g(){return e=
g.__super__.constructor.apply(this,arguments)}q(g,b);g.prototype.defaultPosition="bottom";g.prototype.titleType="titleH";g.prototype._makeTitle=function(b,f){var g,c,d,e,h;g="top"===this.position?b.paddingTop+b.guideTop-(null!=(c=f.top)?c:0)-2:b.height-b.paddingBottom-b.guideBottom+(null!=(d=f.bottom)?d:0);return{type:"text",x:a.identity(b.paddingLeft+b.guideLeft+(b.width-b.paddingLeft-b.guideLeft-b.paddingRight-b.guideRight)/2),y:a.identity(g),color:a.identity(null!=(e=this.color)?e:"black"),size:a.identity(null!=
(h=this.size)?h:12),text:this.titletext,"text-anchor":"middle"}};return g}(n);b=function(b){function g(){return h=g.__super__.constructor.apply(this,arguments)}q(g,b);g.prototype.defaultPosition="left";g.prototype.titleType="titleV";g.prototype._makeTitle=function(b,f){var g,c,d,e,h;g="left"===this.position?b.paddingLeft+b.guideLeft-(null!=(c=f.left)?c:0)-7:b.width-b.paddingRight-b.guideRight+(null!=(d=f.right)?d:0);c=b.paddingTop+b.guideTop+(b.height-b.paddingTop-b.guideTop-b.paddingBottom-b.guideBottom)/
2;return{type:"text",x:a.identity(g),y:a.identity(c),color:a.identity(null!=(e=this.color)?e:"black"),size:a.identity(null!=(h=this.size)?h:12),text:this.titletext,"text-anchor":"middle",transform:"r270"}};return g}(n);d=function(b){function g(){return k=g.__super__.constructor.apply(this,arguments)}q(g,b);g.prototype.titleType="title";g.prototype._makeTitle=function(b,f){var g,c;return{type:"text",x:a.identity(b.width/2),y:a.identity(20),color:a.identity(null!=(g=this.color)?g:"black"),size:a.identity(null!=
(c=this.size)?c:12),text:this.titletext,"font-size":"13px","font-weight":"bold","text-anchor":"middle"}};return g}(n);s=function(b){function g(){this.render=t(this.render,this);this.make=t(this.make,this);return m=g.__super__.constructor.apply(this,arguments)}q(g,b);g.prototype.make=function(a){var b;b=a.title;this.size=a.size;this.color=a.color;return this.titletext=b};g.prototype.render=function(a,b,f){return null!=this.title?this.title=a.animate(this.title,this._makeTitle(b,f)):this.title=a.add(this._makeTitle(b,
f),null,null,"guide-facet-title")};g.prototype._makeTitle=function(b,f){var g,c;return{type:"text",x:a.identity(f.x+b.eachWidth/2),y:a.identity(f.y-7),color:a.identity(null!=(g=this.color)?g:"black"),size:a.identity(null!=(c=this.size)?c:12),text:this.titletext,"text-anchor":"middle"}};return g}(n);null==c.guide&&(c.guide={});c.guide.title=function(a){return"y"===a||"r"===a?new b:"main"===a?new d:"facet"===a?new s:new l}}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m,t,p={}.hasOwnProperty,q=function(a,
b){function f(){this.constructor=a}for(var g in b)p.call(b,g)&&(a[g]=b[g]);f.prototype=b.prototype;a.prototype=new f;a.__super__=b.prototype;return a},f=function(a,b){return function(){return a.apply(b,arguments)}},g=[].indexOf||function(a){for(var b=0,f=this.length;b<f;b++)if(b in this&&this[b]===a)return b;return-1};e=c["const"].scaleFns;n=function(a){function b(){this.axesGeoms={}}q(b,a);b.prototype.make=function(a){var b,f,g,d;this.domains=a.domains;this.coord=a.coord;this.scales=a.scales;this.specs=
a.specs;this.labels=a.labels;return this.axes={x:c.guide.axis(this.coord.axisType("x"),{domain:this.domains.x,type:this.scales.x.tickType(),guideSpec:null!=(b=this.specs.x)?b:{},key:null!=(f=this.labels.x)?f:"x"}),y:c.guide.axis(this.coord.axisType("y"),{domain:this.domains.y,type:this.scales.y.tickType(),guideSpec:null!=(g=this.specs.y)?g:{},key:null!=(d=this.labels.y)?d:"y"})}};b.prototype.getDimension=function(a){var b,f,g;a={};g=this.axes;for(f in g)b=g[f],b=b.getDimension(),"left"===b.position?
a.left=b.width:"right"===b.position?a.right=b.width:"bottom"===b.position?a.bottom=b.height:"top"===b.position&&(a.top=b.height);return a};b.prototype.render=function(a,b,f){var g,d,e,r,h,u,k,I,m,q,l,p,n,t,s,Q;u=_.keys(f.indices);e=c.compare(_.keys(this.axesGeoms),u).deleted;h=0;for(q=e.length;h<q;h++)for(r in d=e[h],l=this.axesGeoms[d],l)d=l[r],d.dispose(b());e={top:0,left:0,right:a.eachWidth,bottom:a.eachHeight,width:a.eachWidth,height:a.eachHeight};r=f.edge(this.axes.x.position);h=f.edge(this.axes.y.position);
q={renderLabel:!1,renderTick:!1};l={renderLabel:!1,renderTick:!1};"r"===this.axes.x.type&&(q.renderLine=!1);"r"===this.axes.y.type&&(l.renderLine=!1);n=0;for(t=u.length;n<t;n++)for(d=u[n],I=f.getOffset(a,d),null==(p=this.axesGeoms)[d]&&(p[d]={x:new c.Geometry("guide"),y:new c.Geometry("guide")}),m=b(I,!1,!1),I=r(d)?{}:q,this.axesGeoms[d].x.set(this.axes.x.calculate(e,this.coord,I)),this.axesGeoms[d].x.render(m),I=h(d)?{}:l,this.axesGeoms[d].y.set(this.axes.y.calculate(e,this.coord,I)),this.axesGeoms[d].y.render(m),
s=["x","y"],I=0,m=s.length;I<m;I++)for(k in g=s[I],Q=this.axesGeoms[d][g].pts,Q)g=Q[k],g.grid&&g.grid.toBack()};b.prototype.dispose=function(a){var b,f,g;g=this.axesGeoms;for(f in g)b=g[f],b.x.dispose(a),b.y.dispose(a);return this.axesGeoms={}};return b}(c.GuideSet);s=function(a){function b(a){this.calculate=f(this.calculate,this);var d,e,r,h,u;d=a.domain;h=a.type;e=a.guideSpec;a=a.key;r=function(a,b){var f;return null!=(f=e[a])?f:b};this.position=r("position",this.defaultPosition);if(u=this.position,
0>g.call(this.validPositions,u))throw c.error.defn("X-axis position can't be "+this.position+".");this.titletext=r("title",a);this.renderTick=r("renderTick",this.renderTickDefault);this.renderGrid=r("renderGrid",this.renderGridDefault);this.renderLabel=r("renderLabel",this.renderLabelDefault);this.renderLine=r("renderLine",this.renderLineDefault);this.gridColor=r("gridColor",this.gridColor);d=c.tick.make(d,e,h);this.ticks=d.ticks;this.ticksFormatter=d.ticksFormatter;this.maxwidth=_.max(_.map(this.ticks,
function(a){return c.strSize(a.value)}));this.maxwidth=Math.max(this.maxwidth,0)}q(b,a);b.prototype.renderTickDefault=!0;b.prototype.renderGridDefault=!0;b.prototype.renderLabelDefault=!0;b.prototype.renderLineDefault=!0;b.prototype.calculate=function(a,b,f){var g,c,d,e,r,h,u;this.coord=b;if("none"===this.position)return{};null==f&&(f={});a.centerx=a.left+a.width/2;a.centery=a.top+a.height/2;a.radius=Math.min(a.width,a.height)/2-10;b={};this.renderLine&&(b.line={marks:{0:this._renderline(a)}});e=
this.ticks;for(g in e)d=e[g],c={},this.renderTick&&(null!=(r=f.renderTick)?r:1)&&(c.tick=this._makeTick(a,d)),this.renderLabel&&(null!=(h=f.renderLabel)?h:1)&&(c.text=this._makeLabel(a,d)),this.renderGrid&&(null!=(u=f.renderGrid)?u:1)&&(c.grid=this._makeGrid(a,d)),b[g]={marks:c};return b};b.prototype._makeTick=function(a){if(!a)throw c.error.impl();a.type="path";a.stroke=e.identity("#666");a.color=e.identity("#666");return a};b.prototype._makeLabel=function(a){if(!a)throw c.error.impl();a.type="text";
a.stroke=e.identity("#666");a.color=e.identity("#666");return a};b.prototype._makeGrid=function(a){if(!a)throw c.error.impl();a.stroke=null!=this.gridColor?this.gridColor:"#EFEFEF";return a};return b}(c.Guide);b=function(a){function b(){return h=b.__super__.constructor.apply(this,arguments)}q(b,a);b.prototype.type="x";b.prototype.renderGridDefault=!1;b.prototype.defaultPosition="bottom";b.prototype.validPositions=["top","bottom","none"];b.prototype._renderline=function(a){var b,f;f="top"===this.position?
...
return b.__super__._makeLabel.call(this,{x:f.location,y:g,text:f.value,"text-anchor":"middle"})};b.prototype._makeGrid=function(a,f){var g,c;g=e.identity(a.top);c=e.identity(a.bottom);return b.__super__._makeGrid.call(this,{type:"path",x:[f.location,f.location],y:[g,c]})};b.prototype.getDimension=function(){var a;return{position:null!=(a=this.position)?a:"bottom",height:30,width:"all"}};return b}(s);a=function(a){function b(){return k=b.__super__.constructor.apply(this,arguments)}q(b,a);b.prototype.type=
"y";b.prototype.renderLineDefault=!1;b.prototype.renderTickDefault=!1;b.prototype.defaultPosition="left";b.prototype.validPositions=["left","right","none"];b.prototype._renderline=function(a){var b,f;b="left"===this.position?e.identity(a.left):e.identity(a.right);f=e.identity(a.top);a=e.identity(a.top+a.height);return{type:"path",x:[b,b],y:[f,a],stroke:e.identity("#666")}};b.prototype._makeTick=function(a,f){var g,c;"left"===this.position?(g=e.identity(a.left),c=e.identity(a.left-5)):(g=e.identity(a.right),
c=e.identity(a.right+5));return b.__super__._makeTick.call(this,{x:[g,c],y:[f.location,f.location]})};b.prototype._makeLabel=function(a,f){var g;g="left"===this.position?e.identity(a.left-7):e.identity(a.right+7);return b.__super__._makeLabel.call(this,{x:g,y:f.location,text:f.value,"text-anchor":"left"===this.position?"end":"start"})};b.prototype._makeGrid=function(a,f){var g,c;g=e.identity(a.left);c=e.identity(a.right);return b.__super__._makeGrid.call(this,{type:"path",y:[f.location,f.location],
x:[g,c]})};b.prototype.getDimension=function(){var a;return{position:null!=(a=this.position)?a:"right",height:"all",width:5+this.maxwidth}};return b}(s);l=function(a){function b(){return m=b.__super__.constructor.apply(this,arguments)}q(b,a);b.prototype.type="r";b.prototype.defaultPosition="left";b.prototype.validPositions=["left","right","none"];b.prototype._renderline=function(a){var b,f;b=e.identity(a.left);f=e.identity(a.top);a=e.identity(a.top+a.height/2);return{type:"path",x:[b,b],y:[f,a],stroke:e.identity("#666")}};
b.prototype._makeTick=function(a,f){return b.__super__._makeTick.call(this,{x:[e.identity(a.left),e.identity(a.left-5)],y:[f.location,f.location]})};b.prototype._makeLabel=function(a,f){return b.__super__._makeLabel.call(this,{x:e.identity(a.left-7),y:f.location,text:f.value,"text-anchor":"end"})};b.prototype._makeGrid=function(a,f){return b.__super__._makeGrid.call(this,{type:"circle",x:e.identity(a.centerx),y:e.identity(a.centery),size:e.identity(this.coord.getScale("r")(f.location)),color:e.identity("none"),
"fill-opacity":0,"stroke-width":1})};b.prototype.getDimension=function(){return{position:"left",height:"all",width:5+this.maxwidth}};return b}(s);d=function(a){function b(){return t=b.__super__.constructor.apply(this,arguments)}q(b,a);b.prototype.type="t";b.prototype.defaultPosition="out";b.prototype.validPositions=["out","none"];b.prototype._renderline=function(a){return{type:"circle",x:e.identity(a.centerx),y:e.identity(a.centery),size:e.identity(a.radius),color:e.identity("none"),stroke:e.identity("#666"),
"stroke-width":1}};b.prototype._makeTick=function(a,f){return b.__super__._makeTick.call(this,{x:[f.location,f.location],y:[e.max(0),e.max(3)]})};b.prototype._makeLabel=function(a,f){return b.__super__._makeLabel.call(this,{x:f.location,y:e.max(12),text:f.value,"text-anchor":"middle"})};b.prototype._makeGrid=function(a,f){var g,c,d,r;c=e.identity(a.centerx);r=e.identity(a.centery);g=this.coord.getScale("t")(f.location)-Math.PI/2;d=e.identity(a.centerx+a.radius*Math.cos(g));g=e.identity(a.centery+
a.radius*Math.sin(g));return b.__super__._makeGrid.call(this,{type:"path",y:[r,g],x:[c,d]})};b.prototype.getDimension=function(){return{}};return b}(s);null==c.guide&&(c.guide={});c.guide.axis=function(f,g){if("x"===f)return new b(g);if("y"===f)return new a(g);if("r"===f)return new l(g);if("t"===f)return new d(g)};c.guide.axes=function(a){return new n(a)}}).call(this);(function(){var n,s,l,d,b,a,e,h={}.hasOwnProperty,k=function(a,b){function f(){this.constructor=a}for(var g in b)h.call(b,g)&&(a[g]=
b[g]);f.prototype=b.prototype;a.prototype=new f;a.__super__=b.prototype;return a},m=[].indexOf||function(a){for(var b=0,f=this.length;b<f;b++)if(b in this&&this[b]===a)return b;return-1},t=function(a,b){return function(){return a.apply(b,arguments)}};b=c["const"].scaleFns;c.guide.legends=function(){return new l};c.guide.legend=function(a,b){return"left"===b||"right"===b?new d(a):new n(a)};l=function(a){function b(){this.legends=[];this.deletedLegends=[]}k(b,a);b.prototype.make=function(a){var b,d,
e,h,k,m,l,p,q,z,n,x;e=a.domains;p=a.layers;h=a.guideSpec;n=a.scales;l=a.layerMapping;this.position=a.position;d=a.dims;null==this.postion&&(this.postion="right");if("none"!==this.position){b=this._mergeAes(e,p);for(m=0;m<this.legends.length;){q=this.legends[m];z=!0;for(k=0;k<b.length;){a=b[k];if(_.isEqual(a,q.aes)){b.splice(k,1);z=!1;break}k++}z?(this.deletedLegends.push(q),this.legends.splice(m,1)):m++}q=0;for(k=b.length;q<k;q++)a=b[q],this.legends.push(c.guide.legend(a,this.position));m=this.legends;
z=[];b=0;for(k=m.length;b<k;b++)q=m[b],a=q.aes[0],z.push(q.make({domain:e[a],position:this.position,guideSpec:null!=(x=h[a])?x:{},type:n[a].tickType(),mapping:l,keys:c.getLabel(p,a),dims:d}));return z}};b.prototype._mergeAes=function(a,b){var d,e,h,k,l,q,p;l=[];for(d in a)if(!(0<=m.call(c["const"].noLegend,d)||(h=_.map(b,function(a){return a.mapping[d]}),_.all(h,_.isUndefined)))){k=!1;q=0;for(p=l.length;q<p;q++)if(e=l[q],_.isEqual(e.mapped,h)){e.aes.push(d);k=!0;break}k||l.push({aes:[d],mapped:h})}return _.pluck(l,
"aes")};b.prototype.getDimension=function(a){var b,c,d;b={};if("left"===(c=this.position)||"right"===c)b[this.position]=this._leftrightWidth(a);else if("top"===(d=this.position)||"bottom"===d)b[this.position]=this._topbottomHeight(a);return b};b.prototype._leftrightWidth=function(a){var b,c,d,e,h,k,m,l;e=a.chartHeight;h=0;b=10;c=0;l=this.legends;k=0;for(m=l.length;k<m;k++)d=l[k],d=d.getDimension(a),d.height+c>e&&(b+=h+5,h=c=0),d.width>h&&(h=d.width),c+=d.height;return b+h};b.prototype._topbottomHeight=
function(a){var b,c,d,e,h;c=10;h=this.legends;d=0;for(e=h.length;d<e;d++)b=h[d],b=b.getDimension(a),c+=b.height+10;return c};b.prototype.render=function(a,b,c){var d,e,h,k,m;e=b();m=this.deletedLegends;h=0;for(k=m.length;h<k;h++)d=m[h],d.dispose(e);this.deletedLegends=[];if("left"===this.position||"right"===this.position)return this._renderV(a,b,c);if("top"===this.position||"bottom"===this.position)return this._renderH(a,b,c)};b.prototype._renderV=function(a,b,c){var d,e,h,k,m,l,q,p,n,x,F,I,H;d=a.paddingTop+
a.guideTop;e="left"===this.position?a.paddingLeft:a.width-a.guideRight-a.paddingRight;m=0;k=a.height-a.guideTop-a.paddingTop;p=10;q="right"===this.position?c.right:0;I=this.legends;H=[];x=0;for(F=I.length;x<F;x++)h=I[x],l=h.getDimension(a),l.height+c.y>k&&(q+=m+5,m=p=0),l.width>m&&(m=l.width),n={x:q+e,y:p+d},h.render(b(n,!1,!1),m),H.push(p+=l.height);return H};b.prototype._renderH=function(a,b,c){var d,e,h,k,m,l;d=a.paddingLeft;e="top"===this.position?a.paddingTop:a.height-a.guideBottom-a.paddingBottom;
e={x:d,y:"top"===this.position?c.top+e:c.bottom+e+10};m=this.legends;l=[];h=0;for(k=m.length;h<k;h++)c=m[h],d=c.getDimension(a),c.render(b(e,!1,!1)),l.push(e.y+=d.height+10);return l};b.prototype.dispose=function(a){var b,c,d,e,h;e=this.legends;h=[];c=0;for(d=e.length;c<d;c++)b=e[c],h.push(b.dispose(a));return h};return b}(c.GuideSet);s=function(a){function d(a){this.aes=a;this._makeEvtData=t(this._makeEvtData,this);this._makeTick=t(this._makeTick,this);this.geometry=new c.Geometry("guide")}k(d,a);
d.prototype.TITLEHEIGHT=15;d.prototype.TICKHEIGHT=12;d.prototype.SPACING=10;d.prototype.make=function(a){var b,d,e,h,k;b=a.domain;e=a.type;d=a.guideSpec;this.mapping=a.mapping;this.position=a.position;a=a.keys;this.titletext=null!=(h=d.title)?h:a;return k=c.tick.make(b,d,e),this.ticks=k.ticks,k};d.prototype.calculate=function(){var a,b,c,d,e;b={};b.title={marks:{0:this._makeTitle(this.titletext)},evtData:{aes:this.aes[0],value:"legendTitle"}};e=this.ticks;for(c in e)a=e[c],d={},d.tick=this._makeTick(a),
d.text=this._makeLabel(a),a=this._makeEvtData(a),b[c]={marks:d,evtData:a};return b};d.prototype.render=function(a){this.geometry.set(this.calculate());return this.geometry.render(a)};d.prototype.dispose=function(a){return this.geometry.dispose(a)};d.prototype._makeTitle=function(a,c){null==c&&(c={x:0,y:0});return{type:"text",x:b.identity(c.x+5),y:b.identity(c.y),color:b.identity("black"),text:a,"text-anchor":"start"}};d.prototype._makeLabel=function(a,c){c||(c={x:0,y:15+12*a.index});return{type:"text",
x:b.identity(c.x+20),y:b.identity(c.y+1),color:b.identity("black"),text:a.value,"text-anchor":"start"}};d.prototype._makeTick=function(a,g){var d,e,h,k;g||(g={x:0,y:15+12*a.index});e={type:"circle",x:b.identity(g.x+10),y:b.identity(g.y),color:b.identity("steelblue")};k=this.mapping;for(d in k)h=k[d],0<=m.call(c["const"].noLegend,d)||(h=h[0],0<=m.call(this.aes,d)?e[d]=a.location:null!=h.type&&"const"===h.type?e[d]=b.identity(h.value):_.isObject(h)?e[d]=b.identity(c["const"].defaults[d]):e[d]=b.identity(h));
_.isObject(e.size)&&(e.size=b.identity(5));return e};d.prototype._makeEvtData=function(a){var b,c,d,e,h,k,l;c={};l=this.mapping;for(b in l)for(e=l[b],h=0,k=e.length;h<k;h++)d=e[h],0<=m.call(this.aes,b)&&"map"===d.type&&(c[d.value]=_.extend(a.evtData,{value:a.location,aes:b}));return c};return d}(c.Guide);d=function(b){function d(){return a=d.__super__.constructor.apply(this,arguments)}k(d,b);d.prototype.make=function(a){var b;d.__super__.make.call(this,a);this.height=this.TITLEHEIGHT+this.SPACING+
this.TICKHEIGHT*_.size(this.ticks);b=c.strSize(this.titletext);a=_.max(_.map(this.ticks,function(a){return c.strSize(a.value)}));return this.maxwidth=Math.max(b,a)};d.prototype.getDimension=function(){return{position:this.position,height:this.height,width:15+this.maxwidth}};return d}(s);n=function(a){function b(){return e=b.__super__.constructor.apply(this,arguments)}k(b,a);b.prototype.TICKSPACING=25;b.prototype.make=function(a){var g,d,e,h;b.__super__.make.call(this,a);this.maxwidth=a.dims.width;
this.height=this.TITLEHEIGHT+this.SPACING;a=0;this.height+=this.TICKHEIGHT;h=this.ticks;d=0;for(e=h.length;d<e;d++)g=h[d],g=c.strSize(g.value)+this.TICKSPACING,a+g<this.maxwidth?a+=g:(this.height+=this.TICKHEIGHT,a=g);return null};b.prototype.calculate=function(){var a,b,d,e,h,k,m;b={};b.title={marks:{0:this._makeTitle(this.titletext)}};h={x:0,y:this.TITLEHEIGHT};m=this.ticks;for(d in m)k=m[d],e={},e.tick=this._makeTick(k,h),e.text=this._makeLabel(k,h),a=this._makeEvtData(k,h),b[d]={marks:e,evtData:a},
a=c.strSize(k.value)+this.TICKSPACING,h.x+a<this.maxwidth?h.x+=a:(h.x=0,h.y+=this.TICKHEIGHT);return b};b.prototype.getDimension=function(){return{position:this.position,height:this.height,width:"all"}};return b}(s)}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m,t,p,q,f,g,r,u,v=function(a,b){return function(){return a.apply(b,arguments)}},C={}.hasOwnProperty,A=function(a,b){function c(){this.constructor=a}for(var f in b)C.call(b,f)&&(a[f]=b[f]);c.prototype=b.prototype;a.prototype=new c;a.__super__=
b.prototype;return a};m=function(){function a(b){this.f=null}a.prototype.make=function(a){this.domain=a;this.compare=c.domain.compare(a);if(!a)return this._makeNone();switch(a.type){case "num":return this._makeNum();case "date":return this._makeDate();case "cat":return this._makeCat()}};a.prototype._makeNone=function(){throw c.error.impl("You are using a scale that does not support null values");};a.prototype._makeNum=function(){throw c.error.impl("You are using a scale that does not support numbers");
};a.prototype._makeDate=function(){throw c.error.impl("You are using a scale that does not support dates");};a.prototype._makeCat=function(){throw c.error.impl("You are using a scale that does not support categories");};a.prototype.tickType=function(){if(!this.domain)return this._tickNone();switch(this.domain.type){case "num":return this._tickNum();case "date":return this._tickDate();case "cat":return this._tickCat()}};a.prototype._tickNone=function(){return"none"};a.prototype._tickNum=function(){return"num"};
a.prototype._tickDate=function(){return"date"};a.prototype._tickCat=function(){return"cat"};a.prototype._identityWrapper=function(a){return function(b){return _.isObject(b)&&"scalefn"===b.t&&"identity"===b.f?b.v:a(b)}};return a}();n=function(a){function b(a){this._catWrapper=v(this._catWrapper,this);this._dateWrapper=v(this._dateWrapper,this);this._numWrapper=v(this._numWrapper,this);this.finv=this.f=null}A(b,a);b.prototype.make=function(a,c,f){this.range=c;this.space=f;_.isNumber(this.space)||(this.space=
0.05);return b.__super__.make.call(this,a)};b.prototype._makeNone=function(){var a,b=this;a=(this.range.max-this.range.min)*this.space;this.f=this._NaNCheckWrap(function(c){var f;if(_.isObject(c))switch(f=function(b){return(this.range.max-this.range.min-2*a)/b},c.f){case "identity":return c.v;case "middle":return b.range.max/2+b.range.min/2;case "max":return b.range.max;case "min":return b.range.min;case "novalue":return b.range.max/2+b.range.min/2;case "upper":return c.m?b.range.min+a+(c.n+1)*f(c.m):
b.range.max-a;case "lower":return c.m?b.range.min+a+c.n*f(c.m):b.range.min+a}else return b.range.max/2+b.range.min/2});return this.finv=function(){return{}}};b.prototype._NaNCheckWrap=function(a){return function(b){if(c.isDefined(b)){b=a(b);if(isNaN(b)||Infinity===b||-Infinity===b)throw c.error.scale("Scale outputed a value that is not finite.");return b}}};b.prototype._numWrapper=function(a,b){var f=this;return this._NaNCheckWrap(function(g){var d,e,h;if(_.isObject(g)){if("scalefn"===g.t)switch(g.f){case "identity":return g.v;
case "middle":return b(g.v+a.bw/2);case "max":return f.range.max+g.v;case "min":return f.range.min+g.v;case "upper":case "lower":h=b(g.v+a.bw);d=b(g.v);e=(h-d)*f.space;if("upper"===g.f&&!g.m)return h-e;if("lower"===g.f&&!g.m)return d+e;h=(h-d-2*e)/g.m;if("upper"===g.f)return d+e+(g.n+1)*h;if("lower"===g.f)return d+e+g.n*h}throw c.error.input("Unknown object "+g+" is passed to a scale");}return b(g)})};b.prototype._dateWrapper=function(a,b){var f=this;return this._NaNCheckWrap(function(g){var d,e,
h,r;if(_.isObject(g)){if("scalefn"===g.t)switch(g.f){case "identity":return g.v;case "max":return f.range.max+g.v;case "min":return f.range.min+g.v;case "upper":case "middle":case "lower":r=function(a,b,c){var f;null==c&&(c=0);f=moment.unix(g.v).startOf(b);f[b](a*Math.floor(f[b]()/a)+a*c);return f.unix()};h=b(function(){switch(a.bw){case "week":return moment.unix(g.v).day(7).unix();case "twomonth":return r(2,"month");case "quarter":return r(4,"month");case "sixmonth":return r(6,"month");case "twoyear":return r(2,
"year");case "fiveyear":return r(5,"year");case "decade":return r(10,"year");default:return moment.unix(g.v).endOf(a.bw).unix()}}());d=b(function(){switch(a.bw){case "week":return moment.unix(g.v).day(0).unix();case "twomonth":return r(2,"month",1);case "quarter":return r(4,"month",1);case "sixmonth":return r(6,"month",1);case "twoyear":return r(2,"year",1);case "fiveyear":return r(5,"year",1);case "decade":return r(10,"year",1);default:return moment.unix(g.v).startOf(a.bw).unix()}}());e=(h-d)*f.space;
if("middle"===g.f)return h/2+d/2;if("upper"===g.f&&!g.m)return h-e;if("lower"===g.f&&!g.m)return d+e;h=(h-d-2*e)/g.m;if("upper"===g.f)return d+e+(g.n+1)*h;if("lower"===g.f)return d+e+g.n*h}throw c.error.input("Unknown object "+g+" is passed to a scale");}return b(g)})};b.prototype._catWrapper=function(a,b){var f=this;return this._NaNCheckWrap(function(g){var d,e,h;e=a*f.space;if(_.isObject(g)){if("scalefn"===g.t)switch(g.f){case "identity":return g.v;case "max":return f.range.max+g.v;case "min":return f.range.min+
g.v;case "upper":case "middle":case "lower":h=b(g.v)+a;d=b(g.v);if("middle"===g.f)return h/2+d/2;if("upper"===g.f&&!g.m)return h-e;if("lower"===g.f&&!g.m)return d+e;h=(h-d-2*e)/g.m;if("upper"===g.f)return d+e+(g.n+1)*h;if("lower"===g.f)return d+e+g.n*h}throw c.error.input("Unknown object "+g+" is passed to a scale");}return b(g)+a/2})};return b}(m);a=function(a){function b(){return t=b.__super__.constructor.apply(this,arguments)}A(b,a);b.prototype._makeNum=function(){var a,b;b=c.linear(this.domain.min,
this.range.min,this.domain.max,this.range.max);a=c.linear(this.range.min,this.domain.min,this.range.max,this.domain.max);this.f=this._numWrapper(this.domain,b);return this.finv=function(b,c){var f;f=[a(b),a(c)];return{ge:_.min(f),le:_.max(f)}}};b.prototype._makeDate=function(){var a,b;b=c.linear(this.domain.min,this.range.min,this.domain.max,this.range.max);a=c.linear(this.range.min,this.domain.min,this.range.max,this.domain.max);this.f=this._dateWrapper(this.domain,b);return this.finv=function(b,
c){var f;f=[a(b),a(c)];return{ge:_.min(f),le:_.max(f)}}};b.prototype._makeCat=function(){var a,b=this;a=(this.range.max-this.range.min)/this.domain.levels.length;this.f=this._catWrapper(a,function(c){c=_.indexOf(b.domain.levels,c);return-1===c?null:b.range.min+c*a});return this.finv=function(c,f){var g;f<c&&(g=[f,c],c=g[0],f=g[1]);return{"in":b.domain.levels.slice(Math.floor(c/a),+Math.floor(f/a)+1||9E9)}}};return b}(n);e=function(a){function b(){return p=b.__super__.constructor.apply(this,arguments)}
A(b,a);b.prototype._makeNum=function(){var a,b,f,g;if(0>this.domain.min)throw c.error.input("Log scale cannot handle zero or negative input.");a=Math.log;f=c.linear(a(this.domain.min),this.range.min,a(this.domain.max),this.range.max);this.f=this._numWrapper(this.domain,function(b){return f(a(b))});g=c.linear(this.range.min,a(this.domain.min),this.range.max,a(this.domain.max));b=function(a){return Math.exp(g(a))};return this.finv=function(a,c){var f;f=[b(a),b(c)];return{ge:_.min(f),le:_.max(f)}}};
b.prototype._tickNum=function(){return"num-log"};return b}(n);n=function(a){function b(){this._makeDate=v(this._makeDate,this);this._makeNum=v(this._makeNum,this);return q=b.__super__.constructor.apply(this,arguments)}A(b,a);b.prototype._makeNum=function(){var a,b,f;a=0===this.domain.min?0:1;b=Math.sqrt;f=c.linear(b(this.domain.min),a,b(this.domain.max),10);return this.f=this._identityWrapper(function(a){return f(b(a))})};b.prototype._makeDate=function(){return this._makeNum()};return b}(m);h=function(a){function b(){this._makeDate=
v(this._makeDate,this);this._makeNum=v(this._makeNum,this);return f=b.__super__.constructor.apply(this,arguments)}A(b,a);b.prototype._makeNum=function(){return this.f=this._identityWrapper(c.linear(this.domain.min,0===this.domain.min?0:0.1,this.domain.max,1))};b.prototype._makeDate=function(){return this._makeNum()};return b}(m);k=function(a){function b(){this._makeCat=v(this._makeCat,this);return g=b.__super__.constructor.apply(this,arguments)}A(b,a);b.prototype._makeCat=function(){var a,b,c,f=this;
c=this.domain.levels.length;if(9>=c)return a="#E41A1C #377EB8 #4DAF4A #984EA3 #FF7F00 #FFFF33 #A65628 #F781BF #999999".split(" "),this.f=function(b){b=_.indexOf(f.domain.levels,b);return a[b]};b=function(a){return _.indexOf(f.domain.levels,a)/c+1/(2*c)};return this.f=function(a){return"undefined"!==typeof Raphael&&null!==Raphael?Raphael.hsl(b(a),0.5,0.5):"hsl("+b(a)+",0.5,0.5)"}};return b}(m);l=function(a){function b(a){this._makeDate=v(this._makeDate,this);this._makeNum=v(this._makeNum,this);this.lower=
a.lower;this.upper=a.upper}A(b,a);b.prototype._makeNum=function(){var a,b,f,g,d;f="undefined"!==typeof Raphael&&null!==Raphael?Raphael.color(this.lower):this.lower;d="undefined"!==typeof Raphael&&null!==Raphael?Raphael.color(this.upper):this.upper;g=c.linear(this.domain.min,f.r,this.domain.max,d.r);b=c.linear(this.domain.min,f.g,this.domain.max,d.g);a=c.linear(this.domain.min,f.b,this.domain.max,d.b);return this.f=this._identityWrapper(function(c){return"undefined"!==typeof Raphael&&null!==Raphael?
Raphael.rgb(g(c),b(c),a(c)):"rgb("+g(c)+","+b(c)+","+a(c)+")"})};b.prototype._makeDate=function(){return this._makeNum()};return b}(m);d=function(a){function b(a){this._makeDate=v(this._makeDate,this);this._makeCat=v(this._makeCat,this);this._makeNum=v(this._makeNum,this);this.lower=a.lower;this.middle=a.middle;this.upper=a.upper;this.midpoint=a.midpoint;null==this.midpoint&&(this.midpoint=0)}A(b,a);b.prototype._makeNum=function(){var a,b,f,g,d,e,h,r,k,m=this;d="undefined"!==typeof Raphael&&null!==
Raphael?Raphael.color(this.lower):this.lower;e="undefined"!==typeof Raphael&&null!==Raphael?Raphael.color(this.middle):this.middle;k="undefined"!==typeof Raphael&&null!==Raphael?Raphael.color(this.upper):this.upper;h=c.linear(this.domain.min,d.r,this.midpoint,e.r);f=c.linear(this.domain.min,d.g,this.midpoint,e.g);a=c.linear(this.domain.min,d.b,this.midpoint,e.b);r=c.linear(this.midpoint,e.r,this.domain.max,k.r);g=c.linear(this.midpoint,e.g,this.domain.max,k.g);b=c.linear(this.midpoint,e.b,this.domain.max,
k.b);return this.f=this._identityWrapper(function(c){return c<m.midpoint?"undefined"!==typeof Raphael&&null!==Raphael?Raphael.rgb(h(c),f(c),a(c)):"rgb("+h(c)+","+f(c)+","+a(c)+")":"undefined"!==typeof Raphael&&null!==Raphael?Raphael.rgb(r(c),g(c),b(c)):"rgb("+r(c)+","+g(c)+","+b(c)+")"})};b.prototype._makeCat=function(){};b.prototype._makeDate=function(){return this._makeNum()};return b}(m);s=function(a){function b(a){this["function"]=a["function"]}A(b,a);b.prototype.make=function(a){this.domain=
a;this.compare=c.domain.compare(a);return this.f=this._identityWrapper(this["function"])};return b}(m);(function(a){function b(){return r=b.__super__.constructor.apply(this,arguments)}A(b,a);b.prototype._makeCat=function(){};return b})(m);b=function(a){function b(){return u=b.__super__.constructor.apply(this,arguments)}A(b,a);b.prototype.make=function(a){this.domain=a;this.compare=function(a,b){return 0};return this.f=this._identityWrapper(function(a){return a})};return b}(m);c.scale={};c.scale.Base=
...
default:throw c.error.data("Unknown data format.");}}();l.key=g.key;l.raw=g.raw;l.meta=g.meta;l.data=l.raw;return f(null,l)});if(null==g)return f(null,this);c.data.frontendProcess(g,this,function(a,b){b.raw=b.data;return f(a,b)})};g.prototype.update=function(a){this.raw=null;return g.__super__.update.call(this)};g.prototype.renameMany=function(a){return 0===_.keys(a).length};return g}(n);s=function(f){function g(a){this.getData=q(this.getData,this);g.__super__.constructor.call(this);this.apiFun=a.apiFun;
this.computeBackend=!0}t(g,f);g.prototype.getData=function(f,g){var d=this;return this.apiFun(g,function(g,m){var l,p,n,q,t;if(null!=g)return f(g,null);if(_.isString(m))try{m=JSON.parse(m)}catch(x){p=x}p=null;try{l=m.data,n=null!=(q=m.meta)?q:{},t=function(){switch(h(l)){case "json-object":return k(l,n);case "json-grid":return a(l,n);case "json-array":return b(l,n);case "csv":return e(l,n);default:throw c.error.data("Unknown data format.");}}(),d.key=t.key,d.raw=t.raw,d.meta=t.meta,d.data=d.raw}catch(F){p=
F}return f(p,d)})};g.prototype.update=function(a){this.raw=null;return g.__super__.update.call(this)};g.prototype.renameMany=function(a){return 0===_.keys(a).length};return g}(n)}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m,t,p=function(a,b){return function(){return a.apply(b,arguments)}},q=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1};n=function(){function a(b,f,d,e){this.parseMethod=null!=e?e:c.spec.layerToData;this._wrap=p(this._wrap,
...
median:function(a){return c.median(a)},box:function(a){var b,d,e,h,k,m;d=a.length;return 5<d?(h=d/2,a=_.sortBy(a,function(a){return a}),b=Math.ceil(h)/2,0!==b%1?(b=Math.floor(b),h=a[b],d=a[d-1-b]):(h=(a[b]+a[b-1])/2,d=(a[d-b]+a[d-b-1])/2),b=d-h,e=h-1.5*b,k=d+1.5*b,b=_.groupBy(a,function(a){return a>=e&&a<=k}),{q1:_.min(b["true"]),q2:h,q3:c.median(a,!0),q4:d,q5:_.max(b["true"]),outliers:null!=(m=b["false"])?m:[]}):{outliers:a}}};d=function(a,b){var d,e,h;h={};_.each(b.stats,function(a){var b,d,e,f;
f=a.name;b=a.expr;a=a.args;d=t[f];e=c.parser.unbracket(a[0].name);return h[b.name]=function(a){return d(_.pluck(a,e))}});e=c.groupBy(a,function(){var a,e,f,h;f=b.groups;h=[];a=0;for(e=f.length;a<e;a++)d=f[a],h.push(c.parser.unbracket(d.name));return h}());return _.map(e,function(a){var d,e,f,k,m;e={};m=b.groups;f=0;for(k=m.length;f<k;f++)d=m[f].name,d=c.parser.unbracket(d),e[d]=a[0][d];for(d in h)f=h[d],e[d]=f(a);return e})};l=function(a,b){var e,h,k,m,l,p,n,q;k=a.key;p=a.sort;q=a.stat;e=a.args;m=
a.limit;h=a.asc;q&&(e={stats:[{name:q,expr:p,args:e}],groups:[k]},b=d(b,e));l=h?1:-1;n=c.parser.unbracket(p.name);b.sort(function(a,b){return a[n]===b[n]?0:a[n]>=b[n]?1*l:-1*l});m&&(b=b.slice(0,+(m-1)+1||9E9));h=_.uniq(_.pluck(b,c.parser.unbracket(k.name)));return{meta:{levels:h,sorted:!0},filter:{expr:k,"in":h}}};m=function(a){var b;b=c.parser.createColTypeEnv(a);return function(a){var d,e,f;d=a.expr;f=d[0];e=d[1];d=null;"call"===f&&"bin"===e.fname&&(e=e.args[1],f=e[0],e=e[1],"const"===f&&(d=c.type.coerce(e.value,
{type:e.type})));return{type:c.parser.getType(a.name,b),bw:d}}};k=function(a,g,h){var k,p,n,q,t,s,E,z,D,x,F;E=null!=(p=_.clone(g.meta))?p:{};t=m(E);p=function(a,b){var c;null==b&&(b={});return E[a.name]=_.extend(null!=(c=E[a.name])?c:{},t(a),b)};g=_.clone(g.raw);k=function(a,b){var c,d,e,f;f=[];d=0;for(e=g.length;d<e;d++)c=g[d],f.push(c[a]=b(c));return f};if(a.trans)for(F=a.trans,z=0,x=F.length;z<x;z++)n=F[z],k(n.name,b(n.expr)),p(n);a.filter&&(g=_.filter(g,e(a.filter)));if(a.sort){k=[];F=a.sort;
z=0;for(x=F.length;z<x;z++)s=F[z],n=s.key,q=l(s,g),s=q.meta,q=q.filter,k.push(q),p(n,s);g=_.filter(g,e(k))}if(a.stats&&a.stats.stats&&0<a.stats.stats.length)for(g=d(g,a.stats),x=a.stats.stats,k=0,z=x.length;k<z;k++)n=x[k],n=n.expr,p(n);a=null!=(D=a.select)?D:[];D=0;for(p=a.length;D<p;D++)if(n=a[D],n=c.parser.unbracket(n.name),null==E[n]&&"count(*)"!==n)throw c.error.defn("You referenced a data column "+n+" that doesn't exist.");return h(null,{data:g,meta:E})};s=function(a,b,c){return b.getData(c,
a)};c.data.frontendProcess=k;c.data.createFunction=b}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m,t,p,q,f,g,r,u,v,C,A,y,J,E=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1},z={}.hasOwnProperty,D=function(a,b){function c(){this.constructor=a}for(var d in b)z.call(b,d)&&(a[d]=b[d]);c.prototype=b.prototype;a.prototype=new c;a.__super__=b.prototype;return a};t=c["const"].aes;q=c["const"].scaleFns;p={x:q.novalue(),y:q.novalue(),color:"steelblue",
...
arguments)}D(b,a);b.prototype._calcGeoms=function(){var a,c,d,e,f,g;b.__super__._calcGeoms.call(this);f=this.geoms;g=[];for(c in f)a=f[c],g.push(function(){var b,c;b=a.marks;c=[];for(d in b)e=b[d],c.push(e.type="spline");return c}());return g};return b}(b);s=function(a){function b(){return v=b.__super__.constructor.apply(this,arguments)}D(b,a);b.prototype._calcGeoms=function(){var a,b;if(this.mapping.y&&"cat"===this.meta[this.mapping.y].type)throw c.error.defn("The dependent variable of a bar chart cannot be categorical!");
...
"opacity"):0}},evtData:a,tooltip:this._tooltip(c)})}return k};return b}(d);n=function(a){function b(){return C=b.__super__.constructor.apply(this,arguments)}D(b,a);b.prototype._calcGeoms=function(){var a,b,d,e,f,g,h,k,m,l,n,p,q,r,t,x;a=function(){var a,b,d,e;d=this.statData;e=[];a=0;for(b=d.length;a<b;a++)k=d[a],c.isDefined(this._getValue(k,"y"))&&c.isDefined(p=this._getValue(k,"x"))&&e.push(p);return e}.call(this);a=_.uniq(a);b={};e=0;for(f=a.length;e<f;e++)l=a[e],b[l]=0;g=function(){var a,b,c,d;
...
d;c++)p=a[c],e.push(b[p]);return e}();x.push(this.geoms[h(n)]={marks:{0:{type:"area",x:a,y:{bottom:l,top:d},color:this._getValue(n,"color"),opacity:this._getValue(n,"opacity")}},evtData:f})}return x};return b}(d);k=function(a){function b(){return A=b.__super__.constructor.apply(this,arguments)}D(b,a);b.prototype._calcGeoms=function(){var a,b,c,d,e,f,g,h,k;b=this._getIdFunc();this.geoms={};h=this.statData;k=[];f=0;for(g=h.length;f<g;f++){c=h[f];a={};for(d in c)e=c[d],a[d]={"in":[e]};k.push(this.geoms[b(c)]=
{marks:{0:{type:"text",x:this._getValue(c,"x"),y:this._getValue(c,"y"),text:this._getValue(c,"text"),color:this._getValue(c,"color"),size:this._getValue(c,"size"),opacity:this._getValue(c,"opacity"),"text-anchor":"center"}},evtData:a})}return k};return b}(d);m=function(a){function b(){return y=b.__super__.constructor.apply(this,arguments)}D(b,a);b.prototype._calcGeoms=function(){var a,b,c,d,e,f,g,h,k;b=this._getIdFunc();this.geoms={};h=this.statData;k=[];f=0;for(g=h.length;f<g;f++){c=h[f];a={};this._getValue(c,
...
c.verticalSpacing)?t:10};l.chartHeight=l.height-l.paddingTop-l.paddingBottom-l.guideTop-l.guideBottom;l.chartWidth=l.width-l.paddingLeft-l.paddingRight-l.guideLeft-l.guideRight;l.eachWidth=null!=s.cols&&1<s.cols?l.chartWidth-l.horizontalSpacing*(s.cols-1):l.chartWidth;l.eachHeight=null!=s.rows&&1<s.rows?l.chartHeight-l.verticalSpacing*(s.rows-1):l.chartHeight;return l}}).call(this);(function(){var n,s,l,d,b,a,e,h,k,m,t,p,q,f,g,r,u,v,C,A,y={}.hasOwnProperty,J=function(a,b){function c(){this.constructor=
...
d,"size"),stroke:c};(b=this._maybeApply(a,d,"color"))&&"none"!==b&&(c.fill=b);return this._shared(a,d,c)};return b}(h);b=function(a){function b(){return q=b.__super__.constructor.apply(this,arguments)}J(b,a);b.prototype._make=function(a){return a.path()};b.prototype.attr=function(a,b,c,d,e){var f;e=b.getXY(e,d);b=e.x;e=e.y;this._checkArrayUndefined(b,e,"Path");c=this._applyOffset(b,e,c);b=c.x;e=c.y;f=this._maybeApply(a,d,d.stroke?"stroke":"color");c=this._maybeApply(a,d,d.size?"size":"stroke-width");
...
d);b=d.x;f=d.y;d=this._checkArrayNaN(b,f);b=d.x;f=d.y;g=this._maybeApply(a,e,e.stroke?"stroke":"color");d=this._maybeApply(a,e,e.size?"size":"stroke-width");return this._shared(a,e,{path:this._makePath(b,f,"spline"),stroke:g,"stroke-width":d})};return b}(d);a=function(a){function b(){return r=b.__super__.constructor.apply(this,arguments)}J(b,a);b.prototype.attr=function(a,b,d,e,f){var g,h,k,m,l;m=b.getXY(f,e);f=m.x;l=m.y;b=m.r;m=m.t;this._checkArrayUndefined(f,l,"Line");l=this._applyOffset(f,l,d);
...
d,"stroke-width")})};return b}(h);l=function(a){function b(){return C=b.__super__.constructor.apply(this,arguments)}J(b,a);b.prototype._make=function(a){return a.path()};b.prototype.attr=function(a,b,d,e,f){var g,h,k,m;g=e.x;h=g[0];g=g[1];m=e.y;k=m[0];m=m[1];this._checkPointUndefined(h,k,"Bar");this._checkPointUndefined(g,m,"Bar");e.x=[h,h,g,g];e.y=[k,m,m,k];g=b.getXY(f,e);h=g.x;k=g.y;f=g.r;g=g.t;d=this._applyOffset(h,k,d);h=d.x;k=d.y;b.flip&&(h.push(h.splice(0,1)[0]),k.push(k.splice(0,1)[0]),f.push(f.splice(0,
...
f[3]+" 0 "+d+" 0 "+h[3]+" "+k[3]+" Z");d=this._maybeApply(a,e,e.stroke?"stroke":"color");return this._shared(a,e,{path:b,fill:this._maybeApply(a,e,"color"),stroke:d,"stroke-width":this._maybeApply(a,e,"stroke-width")})};return b}(h);h=function(a){function b(){return A=b.__super__.constructor.apply(this,arguments)}J(b,a);b.prototype._make=function(a){return a.text()};b.prototype.attr=function(a,b,c,d,e){var f;e=b.getXY(e,d);b=e.x;e=e.y;this._checkPointUndefined(b,e,"Text");c=this._applyOffset(b,e,
...
void 0),y:_.clone(null!=(h=n.guides)?h.y:void 0)};a=void 0;d=["x","y"];k=function(a){return function(b,c,d,e){return"reset"===b?_.isFunction(a)?a("resetZoom",c,d,e):a.handle("resetZoom",c,d,e):_.isFunction(a)?a(b,c,d,e):a.handle(b,c,d,e)}};return function(e,h,p,q){var f,g,r,n,s,C,A,y,J;null==a&&(a=_.clone(q.handlers));if("cartesian"===q.coord.type){if("resetZoom"===e){f=q.spec;g=0;for(r=d.length;g<r;g++)p=d[g],f.guides[p]=_.clone(b[p]);q.handlers=_.clone(a);q.make(q.spec)}if("select"===e){h=h.evtData;
f=q.spec.guides;A=q.spec.layers;J=[];r=0;for(s=A.length;r<s;r++){g=A[r];n=0;for(C=d.length;n<C;n++)p=d[n],l[p]&&null!=g[p]&&(e=c.parser.unbracket(g[p]["var"]),("num"===(y=q.axes.domains[p].type)||"date"===y)&&h[e].le-h[e].ge>c["const"].epsilon&&(null==f[p]&&(f[p]={min:null,max:null}),f[p].min=h[e].ge,f[p].max=h[e].le),"cat"===q.axes.domains[p].type&&0!==h[e]["in"].length&&(null==f[p]&&(f[p]={levels:null}),f[p].levels=h[e]["in"]));q.handlers=_.map(q.handlers,k);J.push(q.make(q.spec))}return J}}}}}).call(this);
...
c.guideTop+(c.eachHeight+c.verticalSpacing)*a.row+c.verticalSpacing}};l.prototype.edge=function(c){var b,a,e,h,k,m,l,p,q=this;if("none"===this.type)return function(){return!0};"grid"===this.type?(p=function(a){return _.indexOf(q.values[q.mapping.y],q.indices[a][q.mapping.y])},b=function(a){return _.indexOf(q.values[q.mapping.x],q.indices[a][q.mapping.x])}):(b=function(a){return _.indexOf(q.values[q.mapping["var"]],q.indices[a][q.mapping["var"]])%q.cols},p=function(a){return Math.floor(_.indexOf(q.values[q.mapping["var"]],
...
d["var"]&&(b.mapping["var"]=c.parser.normalize(d["var"]["var"]))}else if("grid"===d.type){b.type="grid";if(!d.x&&d.y)throw c.error.defn("You didn't specify a variable to facet on.");d.x&&(b.mapping.x=c.parser.normalize(d.x["var"]));d.y&&(b.mapping.y=c.parser.normalize(d.y["var"]))}return b};l.prototype._makeIndices=function(d,b){var a,e,h,k,m,l,p,q;q={};for(a in b)if(e=b[a],m=c.parser.normalize(e["var"]),e.levels)q[m]=e.levels;else{l=[];for(h in d){e=d[h];if(k=e.metaData[m])!k||"num"!==(p=k.type)&&
"date"!==p||c.type.compare(k.type);l=_.uniq(_.union(l,_.pluck(e.statData,m)))}q[m]=l}a=c.cross(q);h={};k=_.pluck(b,"var");l=[];p=0;for(e=k.length;p<e;p++)m=k[p],l.push(c.parser.normalize(m));m=c.stringify(l);e=0;for(k=a.length;e<k;e++)p=a[e],h[m(p)]=p;return{values:q,indices:h}};l.prototype._groupData=function(d,b){var a,e,h,k,m,l,p;e=c.groupProcessedData(d,this.groups);a={};p=this.indices;for(h in p){k=p[h];for(m=e;!0===m.grouped;)l=k[m.key],m=m.values[l];a[h]=m}return a};l.prototype._getRowCol=
function(c){var b;b={row:0,col:0};"wrap"===this.type?(c=this.indices[c][this.mapping["var"]],c=_.indexOf(this.values[this.mapping["var"]],c),b.col=c%this.cols,b.row=Math.floor(c/this.cols)):"grid"===this.type&&(b.row=_.indexOf(this.values[this.mapping.y],this.indices[c][this.mapping.y]),b.col=_.indexOf(this.values[this.mapping.x],this.indices[c][this.mapping.x]));return b};return l}();c.groupProcessedData=function(l,d){var b,a,e,h,k,m,n,p,q;if(0===d.length)return l;b=d.splice(0,1)[0];m=[];for(e in l)a=
l[e],b in a.metaData&&(m=_.union(m,_.uniq(_.pluck(a.statData,b))));k={grouped:!0,key:b,values:{}};p=0;for(q=m.length;p<q;p++){n=m[p];h={};for(e in l)a=l[e],h[e]={metaData:a.metaData},h[e].statData=b in a.metaData?c.filter(a.statData,b,n):_.clone(a.statData);k.values[n]=c.groupProcessedData(h,_.clone(d))}return k}}).call(this);(function(){var n,s,l,d=function(b,a){return function(){return b.apply(a,arguments)}};l=function(b){var a,d,h,k,l,n,p,q,f,g;l=["row","column","value"];d=0;for(k=l.length;d<k;d++)a=
l[d],b[a+"s"]||(b[a+"s"]=[],null!=b[a]&&b[a+"s"].push(b[a]));f=["rows","columns","values"];l=0;for(p=f.length;l<p;l++)for(a=f[l],g=b[a],d=n=0,q=g.length;n<q;d=++n)k=g[d],_.isString(k)&&(b[a][d]={"var":k});null==b.full&&(b.full=!1);null==b.formatter&&(b.formatter={});d=b.formatter;for(h in d)a=d[h],h=c.parser.normalize(h),b.formatter[h]=a;return b};s=function(){function b(a,b,h){var k,l,n,p,q;this.statData=a;this.ticks=b;this.spec=h;this.get=d(this.get,this);this.makeFormatters=d(this.makeFormatters,
...
k;h++)d=b[h],null==a[l=c[d]]&&(a[l]={}),e=a,a=e[c[d]];return e[c[d]]=c};q=this.statData;l=0;for(p=q.length;l<p;l++)h=q[l],n(this.dataIndexByRows,b,h),n(this.dataIndexByCols,a,h)}b.prototype.makeHeaders=function(){var a,b,c=this;a=this.spec.full;b=function(d,l,n,p){var q,f,g;if(0===n.length)return d.push(l);q=n[0];f=n.slice(1);g=_.keys(p);return _.each(c.ticks[q].ticks,function(c,h){var n;if(a||_.contains(g,""+c.location))return n=_.clone(l),n[q]=c.value,b(d,n,f,p[c.location])})};this.rowHeaders=[];
...
p=this.columns.concat(this.rows);a=0;for(b=p.length;a<b;a++)k=p[a],k in this.spec.formatter&&(d[k]=this.spec.formatter[k]);return d};b.prototype.get=function(a,b,c){var d,l,n,p,q;l=this.dataIndexByRows;q=this.rows;n=0;for(p=q.length;n<p;n++)d=q[n],d=this.ticks[d].ticks[a[d]].location,null!=l&&null!=l[d]&&(l=l[d]);p=this.columns;a=0;for(n=p.length;a<n;a++)d=p[a],d=this.ticks[d].ticks[b[d]].location,null!=l&&null!=l[d]&&(l=l[d]);if(null!=l&&null!=l[c])return l[c]};return b}();n=function(){function b(a,
b,h){this.callback=b;this.prepare=h;this.render=d(this.render,this);this.generateTicks=d(this.generateTicks,this);if(null==a)throw c.error.defn("No pivot table specification is passed in!");this.make(a)}b.prototype.make=function(a){this.spec=l(a);return(new c.DataProcess(this.spec,[],this.spec.strict,c.spec.pivotToData)).make(this.spec,[],this.render)};b.prototype.generateTicks=function(a,b,d){var k,l,n,p,q,f,g,r,s,v,C;f={};v=["rows","columns"];g=0;for(r=v.length;g<r;g++)for(k=v[g],C=a[k],k=0,s=C.length;k<
s;k++)q=C[k],q=c.parser.unbracket(q["var"]),p=d[q],n=_.pluck(b,q),n=c.domain.single(n,d[q],{}),p="cat"===p.type?{ticks:n.levels}:"num"===p.type?{numticks:(n.max-n.min)/p.bw}:(l=c["const"].approxTimeInSeconds[p.bw],{numticks:(n.max-n.min)/l}),n=c.tick.make(n,p,d[q].type),f[q]=n;return f};b.prototype.render=function(a,b,d){var k,l,n,p,q,f,g,r,u,v,C,A;a=this.generateTicks(this.spec,b,d);b=new s(b,a,this.spec);d=b.makeHeaders();a=d.rowHeaders;d=d.colHeaders;g=b.makeFormatters();k=this.spec.columns.length;
l=this.spec.rows.length;n=this.spec.values.length;if(!$)throw c.error.depn("Pivot Tables require jQuery!");A=$("<table></table>").attr("border","1px solid black");A.attr("cellspacing",0);A.attr("cellpadding",0);for(r=0;r<k;){C=$("<tr></tr>");q=c.parser.unbracket(this.spec.columns[r]["var"]);0===r&&1<l&&(u=$("<td></td>"),u.attr("rowspan",k),u.attr("colspan",l-1),C.append(u));C.append($("<th>"+q+":</th>").attr("align","right"));for(u=0;u<d.length;){p=d[u][q];for(f=1;u+f<d.length&&p===d[u+f][q];)f++;
g[q]&&(p=g[q](p));p=$("<td class='heading'>"+p+"</td>").attr("colspan",f*n);p.attr("align","center");C.append(p);u+=f}A.append(C);r++}C=$("<tr></tr>");0===l&&(u=$("<td class='spacing'></td>"),u.attr("rowspan",a.length+1),C.append(u));for(r=0;r<l;)q=c.parser.unbracket(this.spec.rows[r]["var"]),C.append($("<th>"+q+"</th>").attr("align","center")),r++;for(r=0;r<d.length;){k=this.spec.values;u=0;for(q=k.length;u<q;u++)p=k[u],p=$("<td class='heading'>"+c.parser.unbracket(p["var"])+"</td>"),p.attr("align",
"center"),C.append(p);r++}A.append(C);for(r=0;r<a.length;){C=$("<tr></tr>");l=this.spec.rows;u=0;for(k=l.length;u<k;u++)if(q=l[u],q=c.parser.unbracket(q["var"]),p=a[r][q],0===r||p!==a[r-1][q]){for(n=1;r+n<a.length&&p===a[r+n][q];)n++;g[q]&&(p=g[q](p));p=$("<td class='heading'>"+p+"</td>").attr("rowspan",n);p.attr("align","center");p.attr("valign","middle");C.append(p)}for(u=0;u<d.length;){q=d[u];k=a[r];f=this.spec.values;l=0;for(n=f.length;l<n;l++)p=f[l],v=c.parser.unbracket(p["var"]),p=(p=b.get(k,
q,v))?g[v](p):"-",C.append($("<td class='value'>"+p+"</td>").attr("align","right"));u++}A.append(C);r++}this.prepare&&this.prepare(this);this.spec.width&&A.attr("width",this.spec.width);this.spec.height&&A.attr("height",this.spec.height);this.dom=_.isString(this.spec.dom)?$("#"+this.spec.dom):$(this.spec.dom);this.dom.empty();this.dom.append(A);if(this.callback)return this.callback(null,this)};return b}();c.pivot=function(b,a,c){return new n(b,a,c)}}).call(this);(function(){var n,s,l=function(b,a){return function(){return b.apply(a,
