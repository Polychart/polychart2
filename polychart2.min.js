...
type:"date"}}}},lag:function(a,b,c){var d;d=b.name;b=b.lag;var e,f;f=[];for(e=1;1<=b?e<=b:e>=b;1<=b?++e:--e)f.push(void 0);return{trans:function(b){f.push(b[a]);return b[d]=f.shift()},meta:{type:c.type}}}};jc=function(a,b,c){return kc[b.trans](a,b,c)};gc={lt:function(a,b){return a<b},le:function(a,b){return a<=b},gt:function(a,b){return a>b},ge:function(a,b){return a>=b},"in":function(a,b){return 0<=lc.call(b,a)}};bb=function(a){var b;b=[];_.each(a,function(a,d){return _.each(a,function(a,c){return b.push(function(b){return gc[c](b[d],
...
var z=function(){};z.prototype.render=function(a,b,c,d,e){var f;a=this._make(a);c=this.attr(b,c,d,e);for(f in c)b=c[f],a.attr(f,b);return a};z.prototype._make=function(){throw h.error.impl();};z.prototype.animate=function(a,b,c,d,e){return a.animate(this.attr(b,c,d,e),300)};z.prototype.attr=function(){throw h.error.impl();};z.prototype._makePath=function(a,b,c){null==c&&(c="L");return _.map(a,function(a,e){return(0===e?"M":c)+a+" "+b[e]}).join(" ")};z.prototype._maybeApply=function(a,b,c){b=b[c];
return _.isObject(b)&&"identity"===b.f?b.v:null!=a[c]?a[c].f(b):b};z.prototype._shared=function(a,b,c){var d,e=this;d=function(d){if(null!=b[d]&&null==c[d])return c[d]=e._maybeApply(a,b,d)};d("opacity");d("stroke-width");d("stroke-dasharray");d("stroke-dashoffset");d("transform");return c};var ha=function(){return ha.__super__.constructor.apply(this,arguments)};O(ha,z);ha.prototype._make=function(a){return a.circle()};ha.prototype.attr=function(a,b,c,d){var e;d=b.getXY(d,c);b=d.x;e=d.y;d=this._maybeApply(a,
c,c.stroke?"stroke":"color");b={cx:b,cy:e,r:this._maybeApply(a,c,"size"),stroke:d};if((d=this._maybeApply(a,c,"color"))&&"none"!==d)b.fill=d;return this._shared(a,c,b)};fb=ha;var ia=function(){return ia.__super__.constructor.apply(this,arguments)};O(ia,z);ia.prototype._make=function(a){return a.path()};ia.prototype.attr=function(a,b,c,d){var e;d=b.getXY(d,c);b=d.x;e=d.y;d=this._maybeApply(a,c,c.stroke?"stroke":"color");return this._shared(a,c,{path:this._makePath(b,e),stroke:d})};gb=ia;var ja=function(){return ja.__super__.constructor.apply(this,
arguments)};O(ja,z);ja.prototype._make=function(a){return a.path()};ja.prototype.attr=function(a,b,c,d){var e;e=h.sortArrays(a.x.sortfn,[c.x,c.y]);c.x=e[0];c.y=e[1];d=b.getXY(d,c);b=d.x;e=d.y;d=this._maybeApply(a,c,c.stroke?"stroke":"color");return this._shared(a,c,{path:this._makePath(b,e),stroke:d})};Fa=ja;var ka=function(){return ka.__super__.constructor.apply(this,arguments)};O(ka,z);ka.prototype._make=function(a){return a.path()};ka.prototype.attr=function(a,b,c,d){var e,f,g,j,l,m;b=b.getXY(d,
c);l=b.x;m=b.y;d=b.r;j=b.t;debugger;var p,n;if(_.max(d)-_.min(d)<h["const"].epsilon){d=d[0];b="M "+l[0]+" "+m[0];f=p=1;for(n=l.length-1;1<=n?p<=n:p>=n;f=1<=n?++p:--p)g=Math.abs(j[f]-j[f-1])>Math.PI?1:0,e=0<j[f]-j[f-1]?1:0,b+="A "+d+" "+d+" 0 "+g+" "+e+" "+l[f]+" "+m[f]}else b=this._makePath(l,m);d=this._maybeApply(a,c,c.stroke?"stroke":"color");return this._shared(a,c,{path:b,stroke:d})};wc=ka;var la=function(){return la.__super__.constructor.apply(this,arguments)};O(la,z);la.prototype._make=function(a){return a.path()};
la.prototype.attr=function(a,b,c,d){var e,f,g;e=h.sortArrays(a.x.sortfn,[c.x,c.y.top]);f=e[0];g=e[1];e=b.getXY(d,{x:f,y:g});g=h.sortArrays(function(b){return-a.x.sortfn(b)},[c.x,c.y.bottom]);f=g[0];g=g[1];b=b.getXY(d,{x:f,y:g});f=e.x.concat(b.x);g=e.y.concat(b.y);return this._shared(a,c,{path:this._makePath(f,g),stroke:this._maybeApply(a,c,"color"),fill:this._maybeApply(a,c,"color"),"stroke-width":"0px"})};eb=la;var ma=function(){return ma.__super__.constructor.apply(this,arguments)};O(ma,z);ma.prototype._make=
function(a){return a.rect()};ma.prototype.attr=function(a,b,c,d){var e;d=b.getXY(d,c);b=d.x;e=d.y;d=this._maybeApply(a,c,c.stroke?"stroke":"color");return this._shared(a,c,{x:_.min(b),y:_.min(e),width:Math.abs(b[1]-b[0]),height:Math.abs(e[1]-e[0]),fill:this._maybeApply(a,c,"color"),stroke:d,"stroke-width":this._maybeApply(a,c,"stroke-width")})};xc=ma;var na=function(){return na.__super__.constructor.apply(this,arguments)};O(na,z);na.prototype._make=function(a){return a.path()};na.prototype.attr=function(a,
b,c,d){var e,f,g,h;h=c.x;g=h[0];h=h[1];e=c.y;f=e[0];e=e[1];c.x=[g,g,h,h];c.y=[f,e,e,f];f=b.getXY(d,c);g=f.x;h=f.y;d=f.r;f=f.t;b.flip&&(g.push(g.splice(0,1)[0]),h.push(h.splice(0,1)[0]),d.push(d.splice(0,1)[0]),f.push(f.splice(0,1)[0]));e=Math.abs(f[1]-f[0])>Math.PI?1:0;b="M "+g[0]+" "+h[0]+" A "+d[0]+" "+d[0]+" 0 "+e+" 1 "+g[1]+" "+h[1];e=Math.abs(f[3]-f[2])>Math.PI?1:0;b+="L "+g[2]+" "+h[2]+" A "+d[2]+" "+d[2]+" 0 "+e+" 0 "+g[3]+" "+h[3]+" Z";d=this._maybeApply(a,c,c.stroke?"stroke":"color");return this._shared(a,
c,{path:b,fill:this._maybeApply(a,c,"color"),stroke:d,"stroke-width":this._maybeApply(a,c,"stroke-width")})};vc=na;var oa=function(){return oa.__super__.constructor.apply(this,arguments)};O(oa,z);oa.prototype._make=function(a){return a.text()};oa.prototype.attr=function(a,b,c,d){var e;b=b.getXY(d,c);return this._shared(a,c,{x:b.x,y:b.y,r:10,text:this._maybeApply(a,c,"text"),"text-anchor":null!=(e=c["text-anchor"])?e:"left",fill:this._maybeApply(a,c,"color")||"black"})};hb=oa;ib={cartesian:{circle:new fb,
line:new Fa,pline:new Fa,area:new eb,path:new gb,text:new hb,rect:new xc},polar:{circle:new fb,path:new gb,line:new Fa,pline:new wc,area:new eb,text:new hb,rect:new vc}};var Ga=function(a,b){return function(){return a.apply(b,arguments)}},C=function(a){this._legacy=Ga(this._legacy,this);this.handleEvent=Ga(this.handleEvent,this);this.merge=Ga(this.merge,this);this.reset=Ga(this.reset,this);var b;if(null==a)throw h.error.defn("No graph specification is passed in!");this.handlers=[];this.paper=this.dims=
