...
function(b){return moment.unix(b).format(c)}};d.format._number_instance=d.format.number();d.format.value=function(c){return _.isNumber(c)?d.format._number_instance(c):c}}).call(this);(function(){var f,r;d.type={};d.type.impute=function(d){var c,b,a,e,g,h;g=b=e=c=0;for(h=d.length;g<h;g++)a=d[g],null!=a&&(void 0!==a&&null!==a)&&(b++,isNaN(a)&&isNaN(a.replace(/\$|\,/g,""))||e++,a=moment(a),null!=a&&a.isValid()&&c++);return e>0.95*b?"num":c>0.95*b?"date":"cat"};d.type.coerce=function(d,c){if(_.isUndefined(d)||
_.isNull(d)||"cat"===c.type)return d;if("num"===c.type)return isNaN(d)?+(""+d).replace(/\$|\,/g,""):+d;if("date"===c.type)return c.format?"unix"===c.format?moment.unix(d).unix():moment(d,c.format).unix():isFinite(d)&&d>=Math.pow(10,9)?moment.unix(d).unix():moment(d).unix()};d.type.compare=function(d){switch(d){case "cat":return f;default:return r}};f=function(d,c){var b,a;if(d===c)return 0;_.isString(d)||(d=""+d);_.isString(c)||(c=""+c);b=d.toLowerCase();a=c.toLowerCase();return b===a?d<c?-1:d>c?
1:0:b<a?-1:b>a?1:0};r=function(d,c){return d===c?0:null===d?1:null===c?-1:d<c?-1:d>c?1:0}}).call(this);(function(){d.spec={};d.spec.toStrictMode=function(f){var r,l,c,b,a,e,g,h;f=_.clone(f);null==f.layers&&f.layer&&(f.layers=[f.layer]);null==f.guides&&f.guide&&(f.guides=f.guide);null==f.guides&&(f.guides={});if(f.layers)for(e=f.layers,r=l=0,b=e.length;l<b;r=++l){c=e[r];h=d["const"].aes;a=0;for(g=h.length;a<g;a++)r=h[a],c[r]&&_.isString(c[r])&&(c[r]={"var":c[r]});null==c.sample&&(c.sample=500)}if(f.facet)for(c=
...
b&&300>b||304===b?c:null,l(b)};return c.send(null)};d.text=function(f,r,l){3>arguments.length&&(l=r,r=null);return d.xhr(f,r,function(c){return l(c&&c.responseText)})};d.json=function(f,r){return d.text(f,"application/json",function(d){return r(d?JSON.parse(d):null)})};d.dsv=function(f,r){var l,c,b,a,e,g,h;h=RegExp("\r\n|["+f+"\r\n]","g");g=RegExp('["'+f+"\n]");l=f.charCodeAt(0);b=function(b){return b.map(a).join(f)};a=function(a){var b;return null!=(b=g.test(a))?b:'"'+a.replace(/\"/g,'""')+{'"':a}};
e=null;c=function(a,b){return d.text(a,r,function(a){return b(a&&c.parse(a))})};c.parse=function(a){return c.parseRows(a,function(a,b){var c,d,k;if(b){k={};c=-1;for(d=e.length;++c<d;)k[e[c]]=a[c];return k}e=a;return null})};c.parseRows=function(a,b){var c,d,e,k,t,s,v,g;d={};c={};s=[];t=0;k=v=null;h.lastIndex=0;for(g=function(){var b,e,t;if(h.lastIndex>=a.length)return c;if(k)return k=!1,d;t=h.lastIndex;if(34===a.charCodeAt(t)){for(e=t;e++<a.length;)if(34===a.charCodeAt(e)){if(34!==a.charCodeAt(e+
1))break;e++}h.lastIndex=e+2;b=a.charCodeAt(e+1);13===b?(k=!0,10===a.charCodeAt(e+2)&&h.lastIndex++):10===b&&(k=!0);return a.substring(t+1,e).replace(/""/g,'"')}if(b=h.exec(a))return k=b[0].charCodeAt(0)!==l,a.substring(t,b.index);h.lastIndex=a.length;return a.substring(t)};(v=g())!==c;){for(e=[];v!==d&&v!==c;)e.push(v),v=g();b&&!(e=b(e,t++))||s.push(e)}return s};c.format=function(a){return a.map(b).join("\n")};return c};d.csv=d.dsv(",","text/csv")}).call(this);(function(){var f,r,l,c,b,a,e,g,h,m,
...
b.prototype.visit=function(a){return a["const"](this,this.val)};return b}(c);f=function(a){function b(a,c){this.fname=a;this.args=c}L(b,a);b.prototype.contents=function(){return[this.fname,G(this.args)]};b.prototype.pretty=function(){var a,b=this.fname,c,d,e,k;e=this.args;k=[];c=0;for(d=e.length;c<d;c++)a=e[c],k.push(a.pretty());return F(b,k)};b.prototype.visit=function(a){var b;return a.call(this,this.fname,function(){var c,d,e,k;e=this.args;k=[];c=0;for(d=e.length;c<d;c++)b=e[c],k.push(b.visit(a));
...
[];b=[];s=[];q={};w=0;for(p=a.length;w<p;w++)c=a[w],"count(*)"===c["var"]?b.push(c["var"]):(e=C(c["var"]),c["var"]=e.pretty(),e=v(e),h.push(e),b.push(c["var"]),0===e.stat.length&&s.push(c["var"]),"sort"in c&&(e=t(c,d["const"].metas),"count(*)"===e.sort?g={sort:"count(*)",asc:e.asc,stat:[],trans:[]}:(g=C(e.sort),e.sort=g.pretty(),g=v(g)),0!==g.stat.length&&(e.stat=g.stat[0]),q[c["var"]]=e));c=x(h);a=u("name");s={stats:a(c.stat),groups:n(s)};return{trans:a(c.trans),stats:s,sort:q,select:n(b),filter:k}},
numeralToData:function(a){var b,c,e,k,s,q,g,h,w,p,m;s={};h=null!=(q=a.filter)?q:{};for(c in h)q=h[c],s[C(c).pretty()]=q;b=_.pick(a,["value"]);for(c in b)"var"in b[c]||delete b[c];w=[];h=[];q=[];a={};for(c in b)e=b[c],"count(*)"===e["var"]?h.push(e["var"]):(k=C(e["var"]),e["var"]=k.pretty(),k=v(k),w.push(k),h.push(e["var"]),0===k.stat.length&&q.push(e["var"]),"sort"in e&&(k=t(e,d["const"].metas),g=C(k.sort),k.sort=g.pretty(),g=v(g),0!==g.stat.length&&(k.stat=g.stat[0]),a[e["var"]]=k));b=x(w);c=u("name");
q={stats:c(null!=(p=b.stat)?p:[]),groups:n(q)};return{trans:c(null!=(m=b.trans)?m:[]),stats:q,sort:a,select:n(h),filter:s}}}}).call(this);(function(){var f,r,l,c,b,a={}.hasOwnProperty,e=function(b,c){function e(){this.constructor=b}for(var d in c)a.call(c,d)&&(b[d]=c[d]);e.prototype=c.prototype;b.prototype=new e;b.__super__=c.prototype;return b},g=function(a,b){return function(){return a.apply(b,arguments)}};r=function(){function a(b){var c;this.spec=b;null==this.spec&&(this.spec={});this.flip=null!=
(c=this.spec.flip)?c:!1;this.scales=null;b=this.flip?["y","x"]:["x","y"];this.x=b[0];this.y=b[1]}a.prototype.make=function(a){return this.dims=a};a.prototype.setScales=function(a){return this.scales={x:a.x.f,y:a.y.f}};a.prototype.clipping=function(a){return[a.x,a.y,this.dims.eachWidth,this.dims.eachHeight]};a.prototype.getScale=function(a){};a.prototype.ranges=function(){};return a}();f=function(a){function b(){return c=b.__super__.constructor.apply(this,arguments)}e(b,a);b.prototype.type="cartesian";
...
2};c.prototype.getScale=function(a){if("r"===a)return this.scales[this.x];if("t"===a)return this.scales[this.y];throw d.error.input("Coordinates only keep r & t scales");};c.prototype.ranges=function(){var a,b,c;b=[this.x,this.y];a=b[0];c=b[1];b={};b[c]={min:0,max:2*Math.PI};b[a]={min:0,max:Math.min(this.dims.eachWidth,this.dims.eachHeight)/2-10};return b};c.prototype.axisType=function(a){return"x"===this[a]?"r":"t"};c.prototype.getXY=function(a,b){var c,e,d,t,s,v,g,h,m,f,y,A,l,w,B=this;f=function(a,
b){return B.cx+a*Math.cos(b-Math.PI/2)};y=function(a,b){return B.cy+a*Math.sin(b-Math.PI/2)};t=[this.x,this.y];s=t[0];g=t[1];if(a){if(_.isArray(b[s])){t={x:[],y:[],r:[],t:[]};l=b[s];e=c=0;for(A=l.length;c<A;e=++c)v=l[e],v=this.scales[s](v),h=this.scales[g](b[g][e]),t.x.push(f(v,h)),t.y.push(y(v,h)),t.r.push(v),t.t.push(h);return t}v=this.scales[s](b[s]);h=this.scales[g](b[g]);return{x:f(v,h),y:y(v,h),r:v,t:h}}d=function(a){return _.isObject(a)&&"scalefn"===a.t&&"identity"===a.f};c=function(a,b){var c,
e;c=d(a);e=d(b);if(c&&!e)return{x:a.v,y:y(B.scales[s](b),0)};if(c&&e)return{x:a.v,y:b.v};if(!c&&e)return{y:b.v,x:y(B.scales[g](a),0)};v=B.scales[s](b);h=B.scales[g](a);return{x:f(v,h),y:y(v,h)}};if(_.isArray(b.x)){t={x:[],y:[]};w=b.x;e=A=0;for(l=w.length;A<l;e=++A)m=w[e],e=b.y[e],m=c(m,e),e=m.x,m=m.y,t.x.push(e),t.y.push(m);return t}return c(b.x,b.y)};return c}(r);d.coord={cartesian:function(a){return new f(a)},polar:function(a){return new l(a)}};d.coord.make=function(a){if(null==a||null==a.type)return d.coord.cartesian();
switch(a.type){case "cartesian":return d.coord.cartesian(a);case "polar":return d.coord.polar(a);default:throw d.error.defn("No such coordinate type "+a.type+".");}}}).call(this);(function(){var f,r,l,c,b,a,e,g,h,m=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1};c=d["const"].aes;d.domain={};d.domain.make=function(a,b,c,e){var k,t,s;k=[];for(s in a)t=a[s],k.push(g(t.geoms,b[s],c,e));return d.domain.merge(k)};d.domain.compare=function(a){return a?
"cat"===a.type?function(b,c){b=_.indexOf(a.levels,b);c=_.indexOf(a.levels,c);return-1===b?1:-1===c?-1:b<c?-1:b>c?1:0}:d.type.compare(a.type):function(a){return a}};l=function(){return function(a){this.type=a.type;this.min=a.min;this.max=a.max;this.bw=a.bw}}();r=function(){return function(a){this.type=a.type;this.min=a.min;this.max=a.max;this.bw=a.bw}}();f=function(){return function(a){this.type=a.type;this.levels=a.levels;this.sorted=a.sorted}}();e=function(a){"cat"!==a.type&&a.max===a.min&&(a.bw?
(a.max+=a.bw,a.min-=a.bw):0===a.max?a.max+=1:(a.max*=1.1,a.min/=1.1));switch(a.type){case "num":return new l(a);case "date":return new r(a);case "cat":return new f(a)}};d.domain.single=function(a,b,c){var u,k,t,s,v,g,h,m,f,y,A,l,w,B,F,G,H,I,r;if(0===a.length)throw d.error.input("Dataset is none?");k=function(a){return null!=c?c[a]:null};switch(b.type){case "num":return u=null!=(s=k("bw"))?s:b.bw,1<a.length?(b=null!=(v=k("min"))?v:_.min(a),t=null!=(l=k("max"))?l:_.max(a)+(null!=u?u:0)):1===a.length?
u?(b=null!=(w=k("min"))?w:a[0],t=null!=(B=k("max"))?B:a[0]+u):(b=null!=(F=k("min"))?F:a[0]-1,t=null!=(G=k("max"))?G:a[0]+1):(b=null!=(H=k("min"))?H:0,t=null!=(I=null!=(r=k("max"))?r:u)?I:1),e({type:"num",min:b,max:t,bw:u});case "date":return u=null!=(g=k("bw"))?g:b.bw,b=null!=(h=k("min"))?h:_.min(a),t=k("max"),null==t&&(t=_.max(a),t=function(){switch(u){case "week":return moment.unix(t).add("days",7).unix();case "twomonth":return moment.unix(t).add("months",2).unix();case "quarter":return moment.unix(t).add("months",
4).unix();case "sixmonth":return moment.unix(t).add("months",6).unix();case "twoyear":return moment.unix(t).add("years",2).unix();case "fiveyear":return moment.unix(t).add("years",5).unix();case "decade":return moment.unix(t).add("years",10).unix();default:return moment.unix(t).add(u+"s",1).unix()}}()),e({type:"date",min:b,max:t,bw:u});case "cat":return e({type:"cat",levels:null!=(m=null!=(f=k("levels"))?f:b.levels)?m:_.uniq(a),sorted:null!=(y=null!=(A=k("levels"))?A:b.sorted)?y:!1})}};g=function(b,
c,g,u){var k,t,s,v,h;t={};for(k in c)v=c[k],s=g[k],0<=m.call(d["const"].noDomain,k)||(u?t[k]=e(g[k]):(h=a(b,k),t[k]=d.domain.single(h,v,s)));return t};a=function(a,b){var c,e,k,t,s;t=[];for(e in a)for(k in c=a[e],s=c.marks,s)c=s[k],t=t.concat(d.flatten(c[b]));s=[];k=0;for(c=t.length;k<c;k++)e=t[k],d.isDefined(e)&&s.push(e);return s};d.domain.merge=function(a){var b,e,d,k,t;d={};k=0;for(t=c.length;k<t;k++)b=c[k],e=_.without(_.pluck(a,b),void 0),0<e.length&&(d[b]=h(e));return d};b={num:function(a){var b,
...
a.left=b.width:"right"===b.position?a.right=b.width:"bottom"===b.position?a.bottom=b.height:"top"===b.position&&(a.top=b.height);return a};b.prototype.render=function(a,b,c){var e,k,s,t,u,g,h,m,f,n,l,q,p,r,J,K;g=_.keys(c.indices);s=d.compare(_.keys(this.axesGeoms),g).deleted;u=0;for(n=s.length;u<n;u++)for(t in k=s[u],l=this.axesGeoms[k],l)k=l[t],k.dispose(b());s={top:0,left:0,right:a.eachWidth,bottom:a.eachHeight,width:a.eachWidth,height:a.eachHeight};t=c.edge(this.axes.x.position);u=c.edge(this.axes.y.position);
n={renderLabel:!1,renderTick:!1};l={renderLabel:!1,renderTick:!1};"r"===this.axes.x.type&&(n.renderLine=!1);"r"===this.axes.y.type&&(l.renderLine=!1);p=0;for(r=g.length;p<r;p++)for(k=g[p],m=c.getOffset(a,k),null==(q=this.axesGeoms)[k]&&(q[k]={x:new d.Geometry("guide"),y:new d.Geometry("guide")}),f=b(m,!1,!1),m=t(k)?{}:n,this.axesGeoms[k].x.set(this.axes.x.calculate(s,this.coord,m)),this.axesGeoms[k].x.render(f),m=u(k)?{}:l,this.axesGeoms[k].y.set(this.axes.y.calculate(s,this.coord,m)),this.axesGeoms[k].y.render(f),
J=["x","y"],m=0,f=J.length;m<f;m++)for(h in e=J[m],K=this.axesGeoms[k][e].pts,K)e=K[h],e.grid&&e.grid.toBack()};b.prototype.dispose=function(a){var b,c,d;d=this.axesGeoms;for(c in d)b=d[c],b.x.dispose(a),b.y.dispose(a);return this.axesGeoms={}};return b}(d.GuideSet);r=function(a){function b(a){this.calculate=u(this.calculate,this);var c,e,s,t,g;c=a.domain;t=a.type;e=a.guideSpec;a=a.key;s=function(a,b){var c;return null!=(c=e[a])?c:b};this.position=s("position",this.defaultPosition);if(g=this.position,
0>k.call(this.validPositions,g))throw d.error.defn("X-axis position can't be "+this.position+".");this.titletext=s("title",a);this.renderTick=s("renderTick",this.renderTickDefault);this.renderGrid=s("renderGrid",this.renderGridDefault);this.renderLabel=s("renderLabel",this.renderLabelDefault);this.renderLine=s("renderLine",this.renderLineDefault);this.gridColor=s("gridColor",this.gridColor);c=d.tick.make(c,e,t);this.ticks=c.ticks;this.ticksFormatter=c.ticksFormatter;this.maxwidth=_.max(_.map(this.ticks,
function(a){return d.strSize(a.value)}));this.maxwidth=Math.max(this.maxwidth,0)}n(b,a);b.prototype.renderTickDefault=!0;b.prototype.renderGridDefault=!0;b.prototype.renderLabelDefault=!0;b.prototype.renderLineDefault=!0;b.prototype.calculate=function(a,b,c){var d,e,k,s,t,u,g;this.coord=b;if("none"===this.position)return{};null==c&&(c={});a.centerx=a.left+a.width/2;a.centery=a.top+a.height/2;a.radius=Math.min(a.width,a.height)/2-10;b={};this.renderLine&&(b.line={marks:{0:this._renderline(a)}});s=
this.ticks;for(d in s)k=s[d],e={},this.renderTick&&(null!=(t=c.renderTick)?t:1)&&(e.tick=this._makeTick(a,k)),this.renderLabel&&(null!=(u=c.renderLabel)?u:1)&&(e.text=this._makeLabel(a,k)),this.renderGrid&&(null!=(g=c.renderGrid)?g:1)&&(e.grid=this._makeGrid(a,k)),b[d]={marks:e};return b};b.prototype._makeTick=function(a){if(!a)throw d.error.impl();a.type="path";a.stroke=e.identity("#666");a.color=e.identity("#666");return a};b.prototype._makeLabel=function(a){if(!a)throw d.error.impl();a.type="text";
a.stroke=e.identity("#666");a.color=e.identity("#666");return a};b.prototype._makeGrid=function(a){if(!a)throw d.error.impl();a.stroke=null!=this.gridColor?this.gridColor:"#EFEFEF";return a};return b}(d.Guide);b=function(a){function b(){return g=b.__super__.constructor.apply(this,arguments)}n(b,a);b.prototype.type="x";b.prototype.renderGridDefault=!1;b.prototype.defaultPosition="bottom";b.prototype.validPositions=["top","bottom","none"];b.prototype._renderline=function(a){var b,c;c="top"===this.position?
...
return b.__super__._makeLabel.call(this,{x:c.location,y:d,text:c.value,"text-anchor":"middle"})};b.prototype._makeGrid=function(a,c){var d,k;d=e.identity(a.top);k=e.identity(a.bottom);return b.__super__._makeGrid.call(this,{type:"path",x:[c.location,c.location],y:[d,k]})};b.prototype.getDimension=function(){var a;return{position:null!=(a=this.position)?a:"bottom",height:30,width:"all"}};return b}(r);a=function(a){function b(){return h=b.__super__.constructor.apply(this,arguments)}n(b,a);b.prototype.type=
"y";b.prototype.renderLineDefault=!1;b.prototype.renderTickDefault=!1;b.prototype.defaultPosition="left";b.prototype.validPositions=["left","right","none"];b.prototype._renderline=function(a){var b,c;b="left"===this.position?e.identity(a.left):e.identity(a.right);c=e.identity(a.top);a=e.identity(a.top+a.height);return{type:"path",x:[b,b],y:[c,a],stroke:e.identity("#666")}};b.prototype._makeTick=function(a,c){var d,k;"left"===this.position?(d=e.identity(a.left),k=e.identity(a.left-5)):(d=e.identity(a.right),
k=e.identity(a.right+5));return b.__super__._makeTick.call(this,{x:[d,k],y:[c.location,c.location]})};b.prototype._makeLabel=function(a,c){var d;d="left"===this.position?e.identity(a.left-7):e.identity(a.right+7);return b.__super__._makeLabel.call(this,{x:d,y:c.location,text:c.value,"text-anchor":"left"===this.position?"end":"start"})};b.prototype._makeGrid=function(a,c){var d,k;d=e.identity(a.left);k=e.identity(a.right);return b.__super__._makeGrid.call(this,{type:"path",y:[c.location,c.location],
x:[d,k]})};b.prototype.getDimension=function(){var a;return{position:null!=(a=this.position)?a:"right",height:"all",width:5+this.maxwidth}};return b}(r);l=function(a){function b(){return m=b.__super__.constructor.apply(this,arguments)}n(b,a);b.prototype.type="r";b.prototype.defaultPosition="left";b.prototype.validPositions=["left","right","none"];b.prototype._renderline=function(a){var b,c;b=e.identity(a.left);c=e.identity(a.top);a=e.identity(a.top+a.height/2);return{type:"path",x:[b,b],y:[c,a],stroke:e.identity("#666")}};
...
e,g,h,m,f,l,q,n,p,w;e=a.domains;l=a.layers;g=a.guideSpec;p=a.scales;f=a.layerMapping;this.position=a.position;c=a.dims;null==this.postion&&(this.postion="right");if("none"!==this.position){b=this._mergeAes(e,l);for(m=0;m<this.legends.length;){q=this.legends[m];n=!0;for(h=0;h<b.length;){a=b[h];if(_.isEqual(a,q.aes)){b.splice(h,1);n=!1;break}h++}n?(this.deletedLegends.push(q),this.legends.splice(m,1)):m++}q=0;for(h=b.length;q<h;q++)a=b[q],this.legends.push(d.guide.legend(a,this.position));m=this.legends;
n=[];b=0;for(h=m.length;b<h;b++)q=m[b],a=q.aes[0],n.push(q.make({domain:e[a],position:this.position,guideSpec:null!=(w=g[a])?w:{},type:p[a].tickType(),mapping:f,keys:d.getLabel(l,a),dims:c}));return n}};b.prototype._mergeAes=function(a,b){var c,e,g,h,f,l,q;f=[];for(c in a)if(!(0<=m.call(d["const"].noLegend,c)||(g=_.map(b,function(a){return a.mapping[c]}),_.all(g,_.isUndefined)))){h=!1;l=0;for(q=f.length;l<q;l++)if(e=f[l],_.isEqual(e.mapped,g)){e.aes.push(c);h=!0;break}h||f.push({aes:[c],mapped:g})}return _.pluck(f,
...
function(a){var b,c,d,e,g;c=10;g=this.legends;d=0;for(e=g.length;d<e;d++)b=g[d],b=b.getDimension(a),c+=b.height+10;return c};b.prototype.render=function(a,b,c){var d,e,g,h,m;e=b();m=this.deletedLegends;g=0;for(h=m.length;g<h;g++)d=m[g],d.dispose(e);this.deletedLegends=[];if("left"===this.position||"right"===this.position)return this._renderV(a,b,c);if("top"===this.position||"bottom"===this.position)return this._renderH(a,b,c)};b.prototype._renderV=function(a,b,c){var d,e,g,h,m,f,l,q,n,w,B,F,G;d=a.paddingTop+
a.guideTop;e="left"===this.position?a.paddingLeft:a.width-a.guideRight-a.paddingRight;m=0;h=a.height-a.guideTop-a.paddingTop;q=10;l="right"===this.position?c.right:0;F=this.legends;G=[];w=0;for(B=F.length;w<B;w++)g=F[w],f=g.getDimension(a),f.height+c.y>h&&(l+=m+5,m=q=0),f.width>m&&(m=f.width),n={x:l+e,y:q+d},g.render(b(n,!1,!1),m),G.push(q+=f.height);return G};b.prototype._renderH=function(a,b,c){var d,e,g,h,m,f;d=a.paddingLeft;e="top"===this.position?a.paddingTop:a.height-a.guideBottom-a.paddingBottom;
e={x:d,y:"top"===this.position?c.top+e:c.bottom+e+10};m=this.legends;f=[];g=0;for(h=m.length;g<h;g++)c=m[g],d=c.getDimension(a),c.render(b(e,!1,!1)),f.push(e.y+=d.height+10);return f};b.prototype.dispose=function(a){var b,c,d,e,g;e=this.legends;g=[];c=0;for(d=e.length;c<d;c++)b=e[c],g.push(b.dispose(a));return g};return b}(d.GuideSet);r=function(a){function c(a){this.aes=a;this._makeEvtData=q(this._makeEvtData,this);this._makeTick=q(this._makeTick,this);this.geometry=new d.Geometry("guide")}h(c,a);
...
0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1};f=function(){function a(b,c,e,g){this.parseMethod=null!=g?g:d.parser.layerToData;this._wrap=p(this._wrap,this);this.make=p(this.make,this);this.layerMeta=b.meta;this.dataObj=b.data;this.prevSpec=null;this.strictmode=e;this.statData=null;this.metaData={}}a.prototype.make=function(a,b,c){var d,g;g=this._wrap(c);this.strictmode&&g({data:this.dataObj.raw,meta:this.dataObj.meta});if(this.dataObj.computeBackend)return d=this.parseMethod(a,
b),this.layerMeta&&(d.meta=this.layerMeta),r(d,this.dataObj,g);d=this.parseMethod(a,b);return this.dataObj.getData(function(a,b){var c,h,k,f;if(null!=a)return g(a,null);if(0<=n.call(d.select,"count(*)")){f=b.data;h=0;for(k=f.length;h<k;h++)c=f[h],c["count(*)"]=1;b.meta["count(*)"]={};b.meta["count(*)"].type="num";d.stats.stats.push({key:"count(*)",name:"count(*)",stat:"count"})}return e(d,b,g)})};a.prototype._wrap=function(a){var b=this;return function(c,e){var d,g;if(null!=c)return a(c,null,null);
d=e.data;g=e.meta;b.statData=d;b.metaData=g;return a(null,b.statData,b.metaData)}};return a}();d.DataProcess=f;d.data.process=function(a,b,c,e){a=new f(b,c);a.process(e);return a};q={bin:function(a,b,c){var e,g;g=b.name;e=b.binwidth;if("num"===c.type){if(isNaN(e))throw d.error.defn("The binwidth "+e+" is invalid for a numeric varliable");e=+e;b=function(b){return b[g]=e*Math.floor(b[a]/e)};return{trans:b,meta:{bw:e,binned:!0,type:"num"}}}if("date"===c.type){if(!(0<=n.call(d["const"].timerange,e)))throw d.error.defn("The binwidth "+
e+" is invalid for a datetime varliable");b=function(b){var c;c=function(c,e){var d;d=moment.unix(b[a]).startOf(e);d[e](c*Math.floor(d[e]()/c));return b[g]=d.unix()};switch(e){case "week":return b[g]=moment.unix(b[a]).day(0).unix();case "twomonth":return c(2,"month");case "quarter":return c(4,"month");case "sixmonth":return c(6,"month");case "twoyear":return c(2,"year");case "fiveyear":return c(5,"year");case "decade":return c(10,"year");default:return b[g]=moment.unix(b[a]).startOf(e).unix()}};return{trans:b,
...
function(b,e){return _.each(b,function(b,d){return c.push(function(c){return a[d](c[e],b)})})});return function(a){var b,e,d;e=0;for(d=c.length;e<d;e++)if(b=c[e],!b(a))return!1;return!0}};g={sum:function(a){return function(a){return _.reduce(_.without(a,void 0,null),function(a,b){return a+b},0)}},mean:function(a){return function(a){a=_.without(a,void 0,null);return _.reduce(a,function(a,b){return a+b},0)/a.length}},count:function(a){return function(a){return _.without(a,void 0,null).length}},unique:function(a){return function(a){return _.uniq(_.without(a,
void 0,null)).length}},min:function(a){return function(a){return _.min(a)}},max:function(a){return function(a){return _.max(a)}},median:function(a){return function(a){return d.median(a)}},box:function(a){return function(a){var b,c,e,g,h,f;c=a.length;return 5<c?(g=c/2,a=_.sortBy(a,function(a){return a}),b=Math.ceil(g)/2,0!==b%1?(b=Math.floor(b),g=a[b],c=a[c-1-b]):(g=(a[b]+a[b-1])/2,c=(a[c-b]+a[c-b-1])/2),b=c-g,e=g-1.5*b,h=c+1.5*b,b=_.groupBy(a,function(a){return a>=e&&a<=h}),{q1:_.min(b["true"]),q2:g,
q3:d.median(a,!0),q4:c,q5:_.max(b["true"]),outliers:null!=(f=b["false"])?f:[]}):{outliers:a}}}};h=function(a){return g[a.stat](a)};c=function(a,b){var c,e;e={};_.each(b.stats,function(a){var b,c,d;b=a.key;c=a.name;d=h(a);return e[c]=function(a){return d(_.pluck(a,b))}});c=d.groupBy(a,b.groups);return _.map(c,function(a){var c;c={};_.each(b.groups,function(b){return c[b]=a[0][b]});_.each(e,function(b,e){return c[e]=b(a)});return c})};l=function(a,b,e){var d,g,h,f;h=b.sort;f=b.stat;d=b.limit;b=b.asc;
f&&(f={stats:[f],groups:[a]},e=c(e,f));g=b?1:-1;e.sort(function(a,b){return a[h]===b[h]?0:a[h]>=b[h]?1*g:-1*g});d&&(e=e.slice(0,+(d-1)+1||9E9));a=_.uniq(_.pluck(e,a));return{meta:{levels:a,sorted:!0},filter:{"in":a}}};e=function(a,e,g){var h,f,q,n,p,r,y,A,E,w,B,F,G;y=_.clone(e.meta);e=_.clone(e.raw);null==y&&(y={});h=function(a,b){var c;return y[a]=_.extend(null!=(c=y[a])?c:{},b)};if(a.trans)for(G=a.trans,n=0,B=G.length;n<B;n++){A=G[n];p=A.key;r=m(p,A,y[p]);f=r.trans;r=r.meta;E=0;for(F=e.length;E<
F;E++)q=e[E],f(q);h(A.name,r)}a.filter&&(e=_.filter(e,b(a.filter)));if(a.sort){f={};A=a.sort;for(p in A)r=A[p],n=l(p,r,e),r=n.meta,n=n.filter,f[p]=n,h(p,r);e=_.filter(e,b(f))}if(a.stats&&a.stats.stats&&0<a.stats.stats.length)for(e=c(e,a.stats),f=a.stats.stats,p=0,r=f.length;p<r;p++)A=f[p],A=A.name,h(A,{type:"num"});a=null!=(w=a.select)?w:[];w=0;for(h=a.length;w<h;w++)if(p=a[w],null==y[p]&&"count(*)"!==p)throw d.error.defn("You referenced a data column "+p+" that doesn't exist.");return g(null,{data:e,
meta:y})};r=function(a,b,c){return b.getData(c,a)};d.data.frontendProcess=e}).call(this);(function(){var f,r,l,c,b,a,e,g,h,m,q,p,n,u,k,t,s,v,z,x,C,D,y=[].indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(b in this&&this[b]===a)return b;return-1},A={}.hasOwnProperty,E=function(a,b){function c(){this.constructor=a}for(var e in b)A.call(b,e)&&(a[e]=b[e]);c.prototype=b.prototype;a.prototype=new c;a.__super__=b.prototype;return a};q=d["const"].aes;n=d["const"].scaleFns;p={x:n.novalue(),y:n.novalue(),
...
e);g=this._getIdFunc();this.geoms={};q=[];for(h in b){a=b[h];m=a[0];c={};k=0;for(l=e.length;k<l;k++)f=e[k],c[f]={"in":[m[f]]};q.push(this.geoms[g(m)]={marks:{0:{type:"path",x:_.map(a,function(a){return n._getValue(a,"x")}),y:_.map(a,function(a){return n._getValue(a,"y")}),color:this._getValue(m,"color"),opacity:this._getValue(m,"opacity"),size:this._getValue(m,"size")}},evtData:c})}return q};return b}(c);b=function(a){function b(){return t=b.__super__.constructor.apply(this,arguments)}E(b,a);b.prototype.defaults=
{x:n.novalue(),y:n.novalue(),color:"steelblue",size:1,opacity:0.9,shape:1};b.prototype._calcGeoms=function(){var a,b,c,e,g,h,f,m,k,l,q,n,p,w,B,s;a=_.uniq(function(){var a,b,c,e;c=this.statData;e=[];a=0;for(b=c.length;a<b;a++)f=c[a],e.push(this._getValue(f,"x"));return e}.call(this));g=function(){var a,b,c,e;c=_.without(_.keys(this.mapping),"x","y");e=[];a=0;for(b=c.length;a<b;a++)m=c[a],e.push(this.mapping[m]);return e}.call(this);c=_.pairs(d.groupBy(this.statData,g));h=this._getIdFunc();this.geoms=
{};q=1===_.max(c,function(a){return a[1].length})[1].length;s=[];e=n=0;for(w=c.length;n<w;e=++n){l=c[e];k=l[0];b=l[1];q&&e+1<c.length&&b.push(c[e+1][1][0]);l=b[0];e={};p=0;for(B=g.length;p<B;p++)k=g[p],e[k]={"in":[l[k]]};b=this._fillZeros(b,a);k=b.x;b=b.y;s.push(this.geoms[h(l)]={marks:{0:{type:"line",x:k,y:b,color:this._getValue(l,"color"),opacity:this._getValue(l,"opacity"),size:this._getValue(l,"size")}},evtData:e})}return s};return b}(c);g=function(a){function b(){return s=b.__super__.constructor.apply(this,
