...
(function() {
  ...
  exprType = function(funcTypeEnv, colTypeEnv, expr) {
    ...
    tapply = function(fname, targs) {
      ...
      if ((fname === 'count' || fname === 'unique') && targs.length === 1) {
        if (targs[0] === tcat) {
          fname = fname + '_cat';
  ...
  layerToDataSpec = function(lspec, grouping) {
    var aesthetics, dedupByName, desc, filters, groups, grpvar, key, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _len4, _m, _ref6, _ref7;

    if (grouping == null) {
      grouping = [];
    }
    filters = {};
    _ref7 = (_ref6 = lspec.filter) != null ? _ref6 : {};
    for (key in _ref7) {
      val = _ref7[key];
    ...
    for (_m = 0, _len4 = grouping.length; _m < _len4; _m++) {
      grpvar = grouping[_m];
      grpvar = parse(grpvar);
  ...
  pivotToDataSpec = function(lspec) {
    var aesthetics, aesthetics_list, dedupByName, desc, filters, groups, item, key, list, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _len4, _len5, _m, _n, _ref6, _ref7;
    ...
    groups = [];
    metas = {};
    for (_n = 0, _len5 = aesthetics_list.length; _n < _len5; _n++) {
      desc = aesthetics_list[_n];
      if (desc["var"] === 'count(*)') {
        select.push(desc["var"]);
      } else {
        desc["var"] = parse(desc["var"]);
  ...
  numeralToDataSpec = function(lspec) {
    var aesthetics, dedupByName, desc, filters, groups, key, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _ref6, _ref7, _ref8, _ref9;
    ...
    dedupByName = dedupOnKey('name');
    stats = {
      stats: dedupByName((_ref8 = transstats.stat) != null ? _ref8 : []),
      groups: dedup(groups)
    };
    return {
      trans: dedupByName((_ref9 = transstats.trans) != null ? _ref9 : []),
      stats: stats,
      sort: metas,
      select: dedup(select),
      filter: filters
  ...
  getExpression = function(str) {
    ...
    statInfo = function() {};
    obj = exprObj(expr);
    _ref6 = obj.expr, rootType = _ref6[0], etc = _ref6[1];
    type = rootType === "ident" ? 'ident' : _.has(expr, 'fname') && ((_ref7 = expr.fname) === 'sum' || _ref7 === 'count' || _ref7 === 'unique' || _ref7 === 'mean' || _ref7 === 'box' || _ref7 === 'median') ? (statInfo = function() {
      var a;

      return {
        fname: expr.fname,
        args: (function() {
          var _len4, _m, _ref8, _results;
...
(function() {
  var DataProcess, backendProcess, calculateMeta, calculateStats, filterFactory, filters, frontendProcess, statistics, transformFactory, transforms,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
