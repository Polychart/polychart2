...
// Generated by CoffeeScript 1.6.2
(function() {
  var PolyCanvas, PolyCanvasItem, PolyCirc, PolyPath, PolyRect, PolyText, _ref, _ref1, _ref2, _ref3,
    __slice = [].slice,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  PolyCanvas = (function() {
    function PolyCanvas(dom, w, h) {
      if (dom.getContext) {
        ...
        throw poly.error.depn("Neither Raphael nor Canvas is available.");
      }
      dom.width = w;
      dom.height = h;
      this.items = [];
    ...
    PolyCanvas.prototype._makeItem = function(type, params) {
      var id, item;

      id = this._newId();
      switch (type) {
        case 'rect':
          item = new PolyRect(id, this, params);
          break;
        case 'circle':
          item = new PolyCirc(id, this, params);
          break;
        case 'path':
          item = new PolyPath(id, this, params);
          break;
        case 'text':
          item = new PolyText(id, this, params);
      }
      this.items[id] = item;
      return item;
    };
  ...
  PolyCanvasItem = (function() {
    function PolyCanvasItem(id, canvas, params) {
      this.id = id;
      this.canvas = canvas;
    ...
    PolyCanvasItem.prototype._setFont = function(fontSize, fontFamily) {
      if (fontFamily != null) {
        return this.context.font = "" + fontSize + "px " + fontFamily;
      } else {
        return this.context.font = "" + fontSize + "px sans-serif";
      }
    };

    PolyCanvasItem.prototype._resetContext = function() {
    ...
    PolyCanvasItem.prototype.attr = function(args) {
      var anchor, key, params, val, _ref;

      if (args.len === 1) {
        params = args[0];
        if (params['stroke-width'] != null) {
          this.context.lineWidth = params['stroke-width'];
        }
        ...
        if (params['font-size'] != null) {
          this._setFont(params['font-size'], params['font-family']);
        }
        if (params['text-anchor'] != null) {
          anchor = params['text-anchor'];
          switch (anchor) {
            case 'left':
              return this.context.textAlign = 'start';
            case 'middle':
              return this.context.textAlign = 'center';
            case 'right':
              return this.context.textAlign = 'right';
          }
        }
      } else {
        _ref = [args[0], args[1]], key = _ref[0], val = _ref[1];
        if (val != null) {
          switch (key) {
            case 'fill':
              return this.context.fillStyle = this._stringToHex(val);
            case 'opacity':
              return this.context.globalAlpha = val;
            case 'stroke':
              return this.context.strokeStyle = this._stringToHex(val);
            case 'stoke-width':
              return this.context.lineWidth = val;
          }
        }
      }
    };

    PolyCanvasItem.prototype._stringToHex = function(colour) {
      switch (colour) {
        case 'black':
          return '#000000';
        case 'white':
    ...
    PolyCanvasItem.prototype._setProps = function(args, props) {
      var key, params, val, _ref,
        _this = this;

      if (args.length === 1) {
        params = args[0];
        return _.each(props, function(prop) {
          if (params[prop] != null) {
            return _this[prop] = params[prop];
          }
        });
      } else {
        _ref = [args[0], args[1]], key = _ref[0], val = _ref[1];
        return _.each(props, function(prop) {
          if (key === prop && (val != null)) {
  ...
  PolyRect = (function(_super) {
    __extends(PolyRect, _super);

    function PolyRect() {
      _ref = PolyRect.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    PolyRect.prototype.attr = function() {
      var args;

      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      PolyRect.__super__.attr.call(this, args);
      this._setProps(args, ['x', 'y', 'width', 'height']);
      return this._draw();
    };

    PolyRect.prototype._draw = function() {
  ...
  PolyCirc = (function(_super) {
    __extends(PolyCirc, _super);

    function PolyCirc() {
      _ref1 = PolyCirc.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    PolyCirc.prototype.attr = function() {
      var args;

      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      PolyCirc.__super__.attr.call(this, args);
      this._setProps(args, ['x', 'y', 'r']);
      return this._draw();
    };

    PolyCirc.prototype._draw = function() {
      this.context.arc(this.cx, this.cy, this.r, 0, 2 * Math.PI, false);
      this.context.fill();
      this.context.stroke();
      return this;
    };
  ...
  PolyPath = (function(_super) {
    __extends(PolyPath, _super);

    function PolyPath() {
      _ref2 = PolyPath.__super__.constructor.apply(this, arguments);
      return _ref2;
    }

    PolyPath.prototype.attr = function() {
      var args;

      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      PolyPath.__super__.attr.call(this, args);
      this._setProps(args, ['path']);
      console.log(args);
      return this._draw();
    };

    PolyPath.prototype._draw = function() {
      var chr, path, x, y;
        ...
        while (path.length > 0) {
          ...
          switch (chr) {
            ...
            case 'Z':
              ...
              break;
            default:
              throw poly.error.defn("Unknown line type!");
          }
        }
        this.context.stroke();
      }
  ...
  PolyText = (function(_super) {
    __extends(PolyText, _super);

    function PolyText() {
      _ref3 = PolyText.__super__.constructor.apply(this, arguments);
      return _ref3;
    }

    PolyText.prototype.attr = function() {
      var args;

      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      PolyText.__super__.attr.call(this, args);
      this._setProps(args, ['x', 'y', 'text']);
      return this._draw();
    };

    PolyText.prototype._draw = function() {
      if (this.text != null) {
