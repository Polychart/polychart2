...
// Generated by CoffeeScript 1.6.2
(function() {
  var Call, Comma, Const, Expr, Ident, LParen, Literal, RParen, Stream, Symbol, Token, assocsToObj, dedup, dedupOnKey, dictGet, dictGets, expect, extractOps, layerToDataSpec, matchToken, mergeObjLists, metricToDataSpec, parse, parseCall, parseCallArgs, parseConst, parseExpr, parseFail, parseSymbolic, pivotToDataSpec, showCall, showList, tag, tokenize, tokenizers, unquote, zip, zipWith, _ref,
    __slice = [].slice,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  metricToDataSpec = function(lspec) {
...
(function() {
  ...
  PivotProcessedData = (function() {
    function PivotProcessedData(statData, spec) {
      var aes, item, row, tmp, tmp_item, tmp_parent, _i, _j, _k, _len, _len1, _len2, _name, _ref, _ref1, _ref2, _ref3;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        row = _ref[_i];
        tmp_parent = this.processedData;
        tmp = this.processedData;
        _ref1 = ['rows', 'columns'];
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          aes = _ref1[_j];
          _ref2 = this.spec[aes];
          for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
            item = _ref2[_k];
            item = item["var"];
            if ((_ref3 = tmp[_name = row[item]]) == null) {
              tmp[_name] = {};
            }
            tmp_parent = tmp;
    ...
    PivotProcessedData.prototype.get = function(rows, columns, val) {
      var i, retvalue, _i, _j, _len, _len1;

      retvalue = this.processedData;
      for (_i = 0, _len = rows.length; _i < _len; _i++) {
        i = rows[_i];
        if ((retvalue != null) && (retvalue[i] != null)) {
          retvalue = retvalue[i];
        }
      }
...
(function() {
  ...
  Metric = (function() {
    ...
    Metric.prototype.make = function(spec) {
      ...
      this.spec = toStrictMode(spec);
      ps = new poly.DataProcess(this.spec, [], this.spec.strict, poly.parser.metricToData);
      return ps.make(this.spec, [], this.render);
    };
