...
// Generated by CoffeeScript 1.6.2
(function() {
  var BaseType, Call, Comma, Conditional, Const, DataType, DataTypeError, Expr, FuncType, Ident, InfixOp, InfixSymbol, Keyword, LParen, Literal, OpStack, Parser, RParen, Stream, Symbol, Token, UnknownType, assertIs, assertTagIs, assocsToObj, bracket, createColTypeEnv, dedup, dedupOnKey, dictGet, dictGets, exprJSON, exprType, extractOps, fname, getExpression, getType, infixGTEQ, infixops, infixpat, infixpats, initialFuncTypeEnv, keywords, layerToDataSpec, makeTypeEnv, matchToken, mergeObjLists, n, numeralToDataSpec, opname, pairNumToNum, parse, pivotToDataSpec, quote, s, showCall, showList, str, symbolOrKeyword, tag, tcat, testColTypeEnv, testExprJSON, testFuncTypeEnv, testTypeCheck, tnum, tokenize, tokenizers, typeCheck, unbracket, unquote, zip, zipWith, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice,
  ...
  FuncType = (function(_super) {
    ...
    FuncType.prototype._unify = function(context, type) {
      ...
      _ref1 = zip(this.domains, type.domains);
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
  ...
  DataType.Base = assocsToObj((function() {
    var _ref1, _results;
  ...
  _ref3 = ['sum', 'count', 'unique', 'mean', 'box', 'median'];
  ...
  layerToDataSpec = function(lspec, grouping) {
    var aesthetics, dedupByName, desc, filters, groups, grpvar, key, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _l, _len3, _ref5, _ref6;

    if (grouping == null) {
      grouping = [];
    }
    filters = {};
    _ref6 = (_ref5 = lspec.filter) != null ? _ref5 : {};
    for (key in _ref6) {
      val = _ref6[key];
    ...
    for (_l = 0, _len3 = grouping.length; _l < _len3; _l++) {
      grpvar = grouping[_l];
      grpvar = parse(grpvar);
  ...
  pivotToDataSpec = function(lspec) {
    var aesthetics, aesthetics_list, dedupByName, desc, filters, groups, item, key, list, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _l, _len3, _len4, _m, _ref5, _ref6;
    ...
    groups = [];
    metas = {};
    for (_m = 0, _len4 = aesthetics_list.length; _m < _len4; _m++) {
      desc = aesthetics_list[_m];
      if (desc["var"] === 'count(*)') {
        select.push(desc["var"]);
      } else {
        desc["var"] = parse(desc["var"]);
  ...
  numeralToDataSpec = function(lspec) {
    var aesthetics, dedupByName, desc, filters, groups, key, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _ref5, _ref6, _ref7, _ref8;
    ...
    dedupByName = dedupOnKey('name');
    stats = {
      stats: dedupByName((_ref7 = transstats.stat) != null ? _ref7 : []),
      groups: dedup(groups)
    };
    return {
      trans: dedupByName((_ref8 = transstats.trans) != null ? _ref8 : []),
      stats: stats,
      sort: metas,
      select: dedup(select),
      filter: filters
  ...
  getType = function(str, typeEnv) {
    return exprType(initialFuncTypeEnv, typeEnv, parse(str));
  };

  getExpression = function(str) {
    var etc, expr, exprObj, obj, rootType, statInfo, type, _ref5, _ref6;
    ...
    type = rootType === "ident" ? 'ident' : _.has(expr, 'fname') && ((_ref6 = expr.fname) === 'sum' || _ref6 === 'count' || _ref6 === 'unique' || _ref6 === 'mean' || _ref6 === 'box' || _ref6 === 'median') ? (statInfo = function() {
      var a;
...
// Generated by CoffeeScript 1.6.2
(function() {
  var createFunction, fns, getMeta;
  ...
  createFunction = function(node) {
    ...
    fn = nodeType === 'ident' ? fns.ident(payload.name) : nodeType === 'const' ? (value = poly.type.coerce(payload.value, {
      type: payload.type
    }), fns["const"](value)) : nodeType === 'infixop' ? (lhs = createFunction(payload.lhs), rhs = createFunction(payload.rhs), fns.infixop[payload.opname](lhs, rhs)) : nodeType === 'conditional' ? (cond = createFunction(payload.cond), conseq = createFunction(payload.conseq), altern = createFunction(payload.altern), fns.conditional(cond, conseq, altern)) : nodeType === 'call' ? (args = (function() {
      var _i, _len, _ref, _results;
      ...
      return _results;
    })(), fns.trans[payload.fname](args)) : void 0;
    if (fn) {
      return fn;
    }
