...
// Generated by CoffeeScript 1.4.0
(function() {
  var Axis, Guide, Legend, RAxis, TAxis, Title, TitleH, XAxis, YAxis, sf,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  ...
  Title = (function(_super) {
    ...
    Title.prototype.make = function(params) {
      var defaultTitle, guideSpec, option,
        _this = this;
      guideSpec = params.guideSpec, defaultTitle = params.defaultTitle;
      option = function(item, def) {
        var _ref;
        return (_ref = guideSpec[item]) != null ? _ref : def;
      };
      return this.titletext = option('title', defaultTitle);
    };

    Title.prototype.render = function(dim, coord, renderer, offset) {
      if (this.position !== 'none') {
        if (this.title != null) {
          return this.title = renderer.animate(this.title, this._makeTitle(dim));
        } else {
          return this.title = renderer.add(this._makeTitle(dim));
        }
      } else {
        if (this.title != null) {
  ...
  TitleH = (function(_super) {
    ...
    TitleH.prototype._makeTitle = function(params) {
      return {
        type: 'text',
...
(function() {
  ...
  ScaleSet = (function() {
    ...
    ScaleSet.prototype.axesOffset = function(dim) {
      var axis, d, done, k2, key, obj, offset, _ref;
      offset = {};
      done = {};
      _ref = this.axes;
      for (key in _ref) {
    ...
    ScaleSet.prototype.legendOffset = function(dim) {
    ...
    ScaleSet.prototype.renderLegends = function(dims, renderer) {
      var legend, maxheight, maxwidth, newdim, o, offset, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
      ...
      offset.x += (_ref1 = o.right) != null ? _ref1 : 0;
      maxwidth = 0;
...
(function() {
  ...
  */
  ...
  Layer = (function() {
    ...
    Layer.prototype._format = function(n) {
      if (_.isNumber(n)) {
        if (!(this._formatnum != null)) {
          this._formatnum = poly.format.number();
        }
...
(function() {
  ...
  poly.dim.make = function(spec, scaleSet, facetGrid) {
    var bottom, dim, left, right, top, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    dim = {
    ...
    _ref9 = scaleSet.legendOffset(dim), left = _ref9.left, right = _ref9.right, top = _ref9.top, bottom = _ref9.bottom;
    dim.guideLeft += left != null ? left : 0;
    dim.guideRight += right != null ? right : 0;
    dim.guideBottom += bottom != null ? bottom : 0;
    dim.guideTop += top != null ? top : 0;
