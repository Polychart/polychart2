...
// Generated by CoffeeScript 1.4.0
(function() {
  var DataError, DefinitionError, DependencyError, MissingData, ModeError, NotImplemented, ScaleError, UnknownInput,
...
(function() {
  var Area, Bar, Box, Layer, Line, Path, Point, Spline, Text, Tile, aesthetics, defaults, sf,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
(function() {
  var Area, Circle, CircleRect, Line, Path, PolarLine, Rect, Renderer, Spline, Text, renderer,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  */
  ...
  Renderer = (function() {
    ...
    Renderer.prototype._makeCurve = function(xs, ys) {
      var curve;
      curve = _.map(xs, function(x, i) {
    ...
    */
    ...
    Graph.prototype.make = function(spec, callback) {
      ...
      for (id = _j = 0, _len1 = _ref2.length; _j < _len1; id = ++_j) {
        ...
        this.dataprocess[id] = new poly.DataProcess(spec, this.facet.specgroups, spec.strict);
        this.dataprocess[id].make(spec, this.facet.specgroups, function(statData, metaData) {
