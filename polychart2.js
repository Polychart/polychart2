...
(function() {
  ...
  getExpression = function(str) {
    ...
    type = rootType === "ident" ? 'ident' : _.has(expr, 'fname') && ((_ref7 = expr.fname) === 'sum' || _ref7 === 'count' || _ref7 === 'unique' || _ref7 === 'mean' || _ref7 === 'box' || _ref7 === 'median' || _ref7 === 'min' || _ref7 === 'max') ? (statInfo = function() {
      var a;
