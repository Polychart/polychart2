...
// Generated by CoffeeScript 1.4.0
(function() {
  var Axis, Guide, Legend, RAxis, TAxis, Title, TitleFacet, TitleH, TitleMain, TitleV, XAxis, YAxis, sf,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
...
(function() {
  ...
  ScaleSet = (function() {
    ...
    ScaleSet.prototype.renderLegends = function(dims, renderer) {
      var legend, maxheight, maxwidth, newdim, offset, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _results;
      ...
      offset.x += (_ref1 = this.axesOffset(dims).right) != null ? _ref1 : 0;
      offset.x += (_ref2 = this.titleOffset(dims).right) != null ? _ref2 : 0;
      maxwidth = 0;
  ...
  */
  ...
  Layer = (function(_super) {
    ...
    Layer.prototype.render = function(renderer) {
      ...
      for (_j = 0, _len1 = added.length; _j < _len1; _j++) {
        id = added[_j];
        newpts[id] = this._add(renderer, geoms[id]);
      }
      for (_k = 0, _len2 = kept.length; _k < _len2; _k++) {
        id = kept[_k];
        newpts[id] = this._modify(renderer, this.pts[id], geoms[id]);
      }
      this.pts = newpts;
      return {
    ...
    Layer.prototype._delete = function(renderer, points) {
      var id2, pt, _results;
      _results = [];
      for (id2 in points) {
        pt = points[id2];
    ...
    Layer.prototype._modify = function(renderer, points, geom) {
    ...
    Layer.prototype._add = function(renderer, geom) {
      var id2, mark, objs, _ref;
      objs = {};
      _ref = geom.marks;
      for (id2 in _ref) {
    ...
    Layer.prototype.dispose = function(renderer) {
      var pt, _i, _len, _ref, _results;
      _ref = this.pts;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        pt = _ref[_i];
        _results.push(this._delete(renderer, pt));
      }
      return _results;
    };
...
(function() {
  ...
  Pane = (function(_super) {
    ...
    Pane.prototype.make = function(spec, data) {
      var id, layer, _i, _len, _ref, _ref1, _ref2;
      if ((_ref = this.layers) == null) {
        this.layers = this._makeLayers(spec);
      }
      if ((_ref1 = this.title) == null) {
