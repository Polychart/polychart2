...
(function() {
  ...
  Graph = (function() {
    ...
    Graph.prototype.makePanes = function() {
      var data, datas, groupedData, groups, index, indices, key, mindex, pane, pointer, stringify, uniqueValues, v, value, _i, _len, _ref, _ref1, _ref2, _ref3, _results;
      groups = (_ref = this.spec.facet) != null ? _ref : [];
      uniqueValues = {};
      for (_i = 0, _len = groups.length; _i < _len; _i++) {
        key = groups[_i];
        v = [];
        _ref1 = this.dataprocess;
        for (index in _ref1) {
          data = _ref1[index];
          if (currGrp in data.metaData) {
      ...
      if ((_ref2 = this.panes) == null) {
        this.panes = this._makePanes(this.spec, this.dataprocess, indices, stringify);
      }
      datas = {};
      groupedData = poly.groupProcessedData(this.dataprocess, groups);
