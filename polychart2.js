...
(function() {
  ...
  PolyCanvasItem = (function() {
    ...
    PolyCanvasItem.prototype.data = function(type, handler) {
      var _base;
      if ((_base = this._interact).data == null) {
        _base.data = {};
      }
...
(function() {
  ...
  Coordinate = (function() {
    function Coordinate(spec) {
      ...
      this.flip = (_ref = this.spec.flip) != null ? _ref : false;
      this.scales = null;
  ...
  Polar = (function(_super) {
    ...
    function Polar() {
      ...
      _ref1 = Polar.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
...
(function() {
  var Title, TitleFacet, TitleH, TitleMain, TitleV, sf, _ref, _ref1, _ref2, _ref3,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  TitleFacet = (function(_super) {
    ...
    function TitleFacet() {
      this.render = __bind(this.render, this);
      this.make = __bind(this.make, this);
      _ref3 = TitleFacet.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
...
(function() {
  var Axes, Axis, RAxis, TAxis, XAxis, YAxis, axisColorMajor, axisColorMinor, sf, _ref, _ref1, _ref2, _ref3,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  ...
  */
  ...
  Axes = (function(_super) {
    ...
    Axes.prototype.render = function(dims, renderer, facet) {
      var added, aes, axis, axisDim, deleted, drawx, drawy, indices, k, kept, key, offset, override, pts, r, type, xoverride, yoverride, _base, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3;
      ...
      for (_j = 0, _len1 = indices.length; _j < _len1; _j++) {
        ...
        if ((_base = this.axesGeoms)[key] == null) {
          _base[key] = {
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          aes = _ref2[_k];
          _ref3 = this.axesGeoms[key][aes].pts;
          for (k in _ref3) {
            pts = _ref3[k];
            if (pts.grid) {
              pts.grid.toBack();
...
(function() {
  ...
  Legends = (function(_super) {
    ...
    Legends.prototype.make = function(params) {
      var aes, aesGroups, dims, domains, guideSpec, i, idx, layerMapping, layers, legend, legenddeleted, scales, _i, _j, _len, _len1, _ref, _ref1, _results;
  ...
  */
  ...
  Area = (function(_super) {
    ...
    function Area() {
      ...
      _ref2 = Area.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  Opacity = (function(_super) {
    ...
    function Opacity() {
      this._makeDate = __bind(this._makeDate, this);
      this._makeNum = __bind(this._makeNum, this);
      _ref3 = Opacity.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  Palette = (function(_super) {
    ...
    function Palette() {
      ...
      _ref4 = Palette.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
...
(function() {
  ...
  ScaleSet = (function() {
    ...
    ScaleSet.prototype.titleOffset = function(dim) {
      var dir, key, o, offset, title, _i, _len, _ref, _ref1;
      offset = {};
      _ref = this.titles;
      for (key in _ref) {
        title = _ref[key];
...
(function() {
  ...
  */
  ...
  _getArray = function(json, meta) {
    var first100, item, key, keys, raw, _i, _j, _k, _len, _len1, _len2;
    if (json.length > 0) {
  ...
  _getArrayOfArrays = function(json, meta) {
    var first100, i, item, key, keys, newitem, raw, retobj, value, _i, _j, _k, _len, _len1, _len2;
    retobj = [];
    if (json.length > 0) {
  ...
  _getObject = function(json, meta) {
    var i, k, key, keys, len, obj, raw, _i, _j, _k, _len, _len1, _ref;
    keys = _.keys(json);
    raw = [];
    for (_i = 0, _len = keys.length; _i < _len; _i++) {
      key = keys[_i];
  ...
  */
  ...
  ApiData = (function(_super) {
    ...
    function ApiData(params) {
      this.getData = __bind(this.getData, this);
      ApiData.__super__.constructor.call(this);
...
(function() {
  ...
  Pane = (function(_super) {
    ...
    Pane.prototype.make = function(spec, data, layers) {
      var geoms, i, layer, meta, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      this.layers = layers;
      if (!this.geoms) {
        this.geoms = {};
        _ref = this.layers;
...
(function() {
  ...
  */
  ...
  poly.handler.zoom = function(init_spec, zoomOptions) {
    ...
    return function(type, obj, event, graph) {
      var aesVar, data, guides, layer, spec, v, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3, _ref4, _results;
            ...
            for (_k = 0, _len2 = aes.length; _k < _len2; _k++) {
              ...
              if ((_ref3 = graph.axes.domains[v].type) === 'num' || _ref3 === 'date') {
                if (data[aesVar].le - data[aesVar].ge > poly["const"].epsilon) {
                  ...
                  _ref4 = [data[aesVar].ge, data[aesVar].le], guides[v].min = _ref4[0], guides[v].max = _ref4[1];
                }
              }
  ...
  PivotProcessedData = (function() {
    function PivotProcessedData(statData, ticks, spec) {
      ...
      _insertInto = function(structure, keys, row) {
        var key, tmp, tmp_parent, _i, _len, _name;
        tmp = tmp_parent = structure;
        for (_i = 0, _len = keys.length; _i < _len; _i++) {
          key = keys[_i];
          if (tmp[_name = row[key]] == null) {
            tmp[_name] = {};
          }
          tmp_parent = tmp;
...
(function() {
  ...
  Numeral = (function() {
    ...
    Numeral.prototype.render = function(err, statData, metaData) {
      var degree, height, scale, width, _ref, _ref1, _ref2, _ref3, _ref4;
      if (err != null) {
        console.error(err);
        return;
      }
      ...
      _ref4 = this.textObj.getBBox(), width = _ref4.width, height = _ref4.height;
  ...
  Graph = (function() {
    ...
    */
    ...
    Graph.prototype.make = function(spec) {
      var d, dataChange, datas, id, layerSpec, merge, _i, _len, _ref,
        _this = this;
      if (spec != null) {
      ...
      _ref = _.difference(datas, this.dataSubscribed);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        d = _ref[_i];
