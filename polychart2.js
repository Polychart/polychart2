...
// Generated by CoffeeScript 1.6.2
(function() {
  var BaseType, Call, Comma, Conditional, Const, DataType, DataTypeError, Expr, FuncType, Ident, InfixOp, InfixSymbol, Keyword, LParen, Literal, OpStack, Parser, RParen, Stream, Symbol, Token, UnknownType, assertIs, assertTagIs, assocsToObj, bracket, dedup, dedupOnKey, dictGet, dictGets, exprJSON, exprType, extractOps, fname, getExpression, infixGTEQ, infixops, infixpat, infixpats, initialFuncTypeEnv, keywords, layerToDataSpec, makeTypeEnv, matchToken, mergeObjLists, n, numeralToDataSpec, opname, pairNumToNum, parse, pivotToDataSpec, quote, s, showCall, showList, str, symbolOrKeyword, tag, tcat, testColTypeEnv, testExprJSON, testFuncTypeEnv, testTypeCheck, tnum, tokenize, tokenizers, typeCheck, unbracket, unquote, zip, zipWith, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice,
...
// Generated by CoffeeScript 1.6.2
(function() {
  var createFunction, fns, infixop, interpret;
  ...
  infixop = function() {
    interpret(lhs);
    return interpret(rhs);
  };

  interpret = function(expr, data, metaData) {
