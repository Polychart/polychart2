...
(function() {
  ...
  */
  ...
  poly.compare = function(oldarr, newarr) {
    var added, deleted, i, j, kept, newElem, oldElem, sortedNewarr, sortedOldarr;
    ...
    sortedOldarr.push(NaN);
    sortedNewarr.push(NaN);
    deleted = [];
    kept = [];
    added = [];
    i = j = 0;
    while (!isNaN(sortedOldarr[i]) || !isNaN(sortedNewarr[j])) {
      oldElem = sortedOldarr[i];
      newElem = sortedNewarr[j];
      if (oldElem < newElem || isNaN(newElem)) {
        deleted.push(oldElem);
        i += 1;
      } else if (oldElem > newElem || isNaN(oldElem)) {
        added.push(newElem);
        j += 1;
