...
// Generated by CoffeeScript 1.6.2
(function() {
  var BaseType, Call, Comma, Conditional, Const, DataType, DataTypeError, Expr, FuncType, Ident, InfixOp, InfixSymbol, Keyword, LParen, Literal, OpStack, Parser, RParen, Stream, Symbol, Token, UnknownType, assertIs, assertTagIs, assocsToObj, bracket, dedup, dedupOnKey, dictGet, dictGets, exprJSON, exprType, extractOps, infixGTEQ, infixops, infixpat, infixpats, initialTypeEnv, keywords, layerToDataSpec, matchToken, mergeObjLists, n, numeralToDataSpec, opname, pairNumToNum, parse, pivotToDataSpec, quote, s, showCall, showList, str, symbolOrKeyword, tag, tcat, testExprJSON, testTypeCheck, tnum, tokenize, tokenizers, typeCheck, unbracket, unquote, zip, zipWith, _i, _len, _ref, _ref1, _ref2,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice,
  ...
  layerToDataSpec = function(lspec, grouping) {
    var aesthetics, dedupByName, desc, filters, groups, grpvar, key, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _j, _len1, _ref3, _ref4;

    if (grouping == null) {
      grouping = [];
    }
    filters = {};
    _ref4 = (_ref3 = lspec.filter) != null ? _ref3 : {};
    for (key in _ref4) {
      val = _ref4[key];
  ...
  pivotToDataSpec = function(lspec) {
    var aesthetics, aesthetics_list, dedupByName, desc, filters, groups, item, key, list, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _j, _k, _len1, _len2, _ref3, _ref4;
    ...
    groups = [];
    metas = {};
    for (_k = 0, _len2 = aesthetics_list.length; _k < _len2; _k++) {
      desc = aesthetics_list[_k];
      if (desc["var"] === 'count(*)') {
        select.push(desc["var"]);
      } else {
        desc["var"] = parse(desc["var"]);
  ...
  numeralToDataSpec = function(lspec) {
    var aesthetics, dedupByName, desc, filters, groups, key, metas, result, sdesc, select, stats, transstat, transstats, ts, val, _ref3, _ref4, _ref5, _ref6;
    ...
    dedupByName = dedupOnKey('name');
    stats = {
      stats: dedupByName((_ref5 = transstats.stat) != null ? _ref5 : []),
      groups: dedup(groups)
    };
    return {
      trans: dedupByName((_ref6 = transstats.trans) != null ? _ref6 : []),
      stats: stats,
      sort: metas,
      select: dedup(select),
      filter: filters
  ...
  typeCheck = function(str) {
    ...
    expr = parse(str);
    return exprType(initialTypeEnv, expr);
  };
