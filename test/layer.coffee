...
test "point", ->
  ...
  {layers} = gg.chart spec
  layer = layers[0]

  equal layer.geoms[0].marks[0].type, 'circle'
  equal layer.geoms[0].marks[0].x, 2
  equal layer.geoms[0].marks[0].y, 4
  deepEqual layer.geoms[0].marks[0].color, gg.const.scaleFns.identity(layer.defaults.color)
  ...
  deepEqual layer.geoms[1].marks[0].color, gg.const.scaleFns.identity(layer.defaults.color)
...
test "bars", ->
  ...
  deepEqual layer.geoms['foo'].marks[0].x[0] , gg.const.scaleFns.lower 'A'
  deepEqual layer.geoms['foo'].marks[0].x[1] , gg.const.scaleFns.upper 'A'
  equal layer.geoms['foo'].marks[0].y[0] , 0
  equal layer.geoms['foo'].marks[0].y[1] , 4
  equal layer.geoms['bar'].marks[0].type, 'rect'
  deepEqual layer.geoms['bar'].marks[0].x[0] , gg.const.scaleFns.lower 'A'
  deepEqual layer.geoms['bar'].marks[0].x[1] , gg.const.scaleFns.upper 'A'
